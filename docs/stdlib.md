...
| [`socket_cookie`](#socket_cookie) | Retrieve the cookie (generated by the kernel) of the socket. |
...
#### Parameters
- **$sk**: (struct sock*) The socket to load the cookie from

#### Last Expression
- **u64**: The cookie value
