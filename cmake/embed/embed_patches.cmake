...
function(prepare_clang_patches patch_command)
  ...
  if(HOST_OS_ID STREQUAL "debian" OR HOST_OS_ID STREQUAL "ubuntu" OR HOST_OS_FAMILY STREQUAL "debian")
    ...
    if(${LLVM_VERSION} VERSION_EQUAL "8.0.1")
    ...
    elseif(${LLVM_VERSION} VERSION_EQUAL "12.0.0")
      set(DEBIAN_PATCH_URL "https://salsa.debian.org/pkg-llvm-team/llvm-toolchain/-/archive/12/llvm-toolchain-12.tar.gz?path=debian/patches")
      set(DEBIAN_PATCH_CHECKSUM 88a77e2c7d43a38d27bcda27498b205c1d0973a150dd6bf724566cab87361ea7)
    else()
