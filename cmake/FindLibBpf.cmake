...
if (USE_SYSTEM_LIBBPF)
  ...
  set(LIBBPF_ERROR_MESSAGE
    "Please install the libbpf.a static library or set -DUSE_SYSTEM_LIBBPF=Off
    to vendor libbpf")
else()
  ...
  # 2. For stdlib since libbpf headers are included in stdlib (and the rules to
  #    embed them are generated in configure phase).
  execute_process(
