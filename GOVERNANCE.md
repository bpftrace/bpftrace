...
- fixing bugs
- adding features
- facilitating distrubtion (e.g. packaging for Ubuntu)
...
New committers can be nominated by any existing maintainer (see below). Once they have been nominated, there will be an informal majority vote either offline or in the bpftrace office hours. Please be advised we're still working out the logistics of the nomination and approval process for new committers.
...
To become a maintainer, you have to first be a committer. Any maintainer can nominate a committer for maintainership. Once they have been nominated, there will be an informal majority vote amongst maintainers only. Please be advised we're still working out the logistics of the nomination and approval process for new maintainers.
...
### Voting
Issues such as those affecting the strategic direction or legal standing of the project must gain explicit approval in the form of a vote. Every member of the community is encouraged to express their opinions in all discussion and all votes. However, only project maintainers (as defined above) have binding votes for the purposes of decision making. Please be advised we're still working out the logistics of voting process.
