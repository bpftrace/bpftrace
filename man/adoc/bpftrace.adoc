...
Signal probes are special built-in events provided by the bpftrace runtime.
These are triggered when a specified signal is received. Currently, only SIGUSR1 is supported.
