...
All positional and named parameters should come after the script filename or a double dash if running an inline script with `-e` e.g.
```
...
* `int getopt(string arg_name, true|false)`
