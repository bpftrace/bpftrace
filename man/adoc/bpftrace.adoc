...
By default, bpftrace requires at least one probe to attach successfully or else an error is returned. However this can be changed using the `missing_probes` config variable.
