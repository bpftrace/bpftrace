...
A block can be used as expression, as long as the last line of the block is an
expression with no trailing semi-colon.
...
This can be used anywhere a regular expression can be used.
