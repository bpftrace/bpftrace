...
static std::unique_ptr<BPFtrace> get_default_bpftrace(int call_times = 1)
{
...
{
  auto bpftrace = get_default_bpftrace();
...
{
  auto bpftrace = get_default_bpftrace(4);
...
{
  auto bpftrace = get_default_bpftrace(2);
