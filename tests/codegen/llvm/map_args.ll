...
define i64 @"uprobe:/tmp/bpftrace-test-dwarf-data:func_1"(i8* %0) section "s_uprobe:/tmp/bpftrace-test-dwarf-data:func_1_1" !dbg !29 {
entry:
...
!29 = distinct !DISubprogram(name: "uprobe__tmp_bpftrace_test_dwarf_data_func_1", linkageName: "uprobe__tmp_bpftrace_test_dwarf_data_func_1", scope: !2, file: !2, type: !30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !25, retainedNodes: !33)
