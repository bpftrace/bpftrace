...
define internal i64 @map_len_cb(i8* %0, i8* %1, i8* %2, i8* %3) section ".text" !dbg !61 {
...
!61 = distinct !DISubprogram(name: "map_len_cb", linkageName: "map_len_cb", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !47, retainedNodes: !62)
!62 = !{!63}
