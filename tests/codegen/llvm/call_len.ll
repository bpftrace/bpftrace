...
define i64 @"kprobe:f"(i8* %0) section "s_kprobe:f_2" !dbg !59 {
entry:
  ...
  %for_each_map_elem = call i64 inttoptr (i64 164 to i64 (%"struct map_t"*, i64 (i8*, i8*, i8*, i8*)*, i8*, i64)*)(%"struct map_t"* @AT_x, i64 (i8*, i8*, i8*, i8*)* @map_len_cb, i8* %3, i64 0)
...
define internal i64 @map_len_cb(i8* %0, i8* %1, i8* %2, i8* %3) section ".text" !dbg !63 {
...
!59 = distinct !DISubprogram(name: "kprobe_f", linkageName: "kprobe_f", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !60)
!60 = !{!61, !62}
!61 = !DILocalVariable(name: "var0", scope: !59, file: !2, type: !18)
!62 = !DILocalVariable(name: "var1", arg: 1, scope: !59, file: !2, type: !54)
!63 = distinct !DISubprogram(name: "map_len_cb", linkageName: "map_len_cb", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !47, retainedNodes: !64)
!64 = !{!65, !66}
