...
define i64 @kprobe_f_2(ptr %0) section "s_kprobe_f_2" !dbg !69 {
entry:
...
define internal i64 @map_len_cb(ptr %0, ptr %1, ptr %2, ptr %3) section ".text" !dbg !72 {
...
!69 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !64, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !60, retainedNodes: !70)
!70 = !{!71}
!71 = !DILocalVariable(name: "ctx", arg: 1, scope: !69, file: !2, type: !66)
!72 = distinct !DISubprogram(name: "map_len_cb", linkageName: "map_len_cb", scope: !2, file: !2, type: !64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !60, retainedNodes: !73)
!73 = !{!74}
