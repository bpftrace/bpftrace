...
"&&_merge":                                       ; preds = %"&&_false", %"&&_true"
  ...
  %11 = getelementptr [1 x [1 x [8 x i8]]], ptr @write_map_val_buf, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
  store i64 %9, ptr %11, align 8
  %update_elem = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %"@x_key", ptr %11, i64 0)
