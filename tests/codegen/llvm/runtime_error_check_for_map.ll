...
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !51
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !53

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @BEGIN_1(ptr %0) #0 section "s_BEGIN_1" !dbg !64 {
entry:
...
event_loss_counter:                               ; preds = %helper_failure
  ...
  %9 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
event_loss_counter5:                              ; preds = %helper_failure1
  ...
  %16 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded9, i64 0, i64 0
...
; Function Attrs: nounwind
define internal i64 @map_for_each_cb(ptr %0, ptr %1, ptr %2, ptr %3) #0 section ".text" !dbg !70 {
for_body:
  %helper_error_t = alloca %helper_error_t, align 8
...
event_loss_counter:                               ; preds = %helper_failure
  ...
  %12 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
!52 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !24, isLocal: false, isDefinition: true)
!53 = !DIGlobalVariableExpression(var: !54, expr: !DIExpression())
!54 = distinct !DIGlobalVariable(name: "__bt__event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !55, isLocal: false, isDefinition: true)
...
!64 = distinct !DISubprogram(name: "BEGIN_1", linkageName: "BEGIN_1", scope: !2, file: !2, type: !65, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !60, retainedNodes: !68)
...
!70 = distinct !DISubprogram(name: "map_for_each_cb", linkageName: "map_for_each_cb", scope: !2, file: !2, type: !71, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !60, retainedNodes: !73)
!71 = !DISubroutineType(types: !72)
!72 = !{!24, !67, !67, !67, !67}
!73 = !{!74, !75, !76, !77}
!74 = !DILocalVariable(name: "map", arg: 1, scope: !70, file: !2, type: !67)
!75 = !DILocalVariable(name: "key", arg: 2, scope: !70, file: !2, type: !67)
!76 = !DILocalVariable(name: "value", arg: 3, scope: !70, file: !2, type: !67)
!77 = !DILocalVariable(name: "ctx", arg: 4, scope: !70, file: !2, type: !67)
