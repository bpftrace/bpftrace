...
@__bt__event_loss_counter = dso_local externally_initialized global i64 0, section ".data.event_loss_counter", !dbg !62
...
lookup_failure:                                   ; preds = %entry
  ...
  %5 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 0
  store i64 0, ptr %5, align 8
  %6 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 1
  store i64 0, ptr %6, align 8
  %7 = getelementptr %t_series_val, ptr %ts_struct, i64 0, i32 2
...
maybe_clear:                                      ; preds = %lookup_failure, %lookup_success
  %8 = load ptr, ptr %ts_struct_ptr, align 8
  %9 = getelementptr %t_series_val, ptr %8, i64 0, i32 0
  %10 = getelementptr %t_series_val, ptr %8, i64 0, i32 1
  %11 = getelementptr %t_series_val, ptr %8, i64 0, i32 2
  br label %merge
...
update:                                           ; preds = %lookup_merge
  %update_elem6 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %"@x_key", ptr %8, i64 0)
  br label %exit
...
lookup_success3:                                  ; preds = %merge
  %12 = load i64, ptr %lookup_elem2, align 8
  store i64 %12, ptr %lookup_elem_val, align 8
...
lookup_merge:                                     ; preds = %lookup_failure4, %lookup_success3
  %13 = load i64, ptr %lookup_elem_val, align 8
  call void @llvm.lifetime.end.p0(i64 -1, ptr %lookup_elem_val)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@a_key1")
  store i64 %13, ptr %9, align 8
  store i64 %get_ns, ptr %10, align 8
  store i64 %1, ptr %11, align 8
  %14 = load i8, ptr %key_exists, align 1
  %needs_update = icmp ne i8 %14, 1
...
!63 = distinct !DIGlobalVariable(name: "__bt__event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
