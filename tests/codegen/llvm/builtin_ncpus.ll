...
entry:
  ...
  %num_cpu.cmp = load i64, ptr @__bt__num_cpus, align 8
...
!46 = distinct !DIGlobalVariable(name: "__bt__num_cpus", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
