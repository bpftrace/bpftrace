...
helper_merge:                                     ; preds = %counter_merge, %entry
  ...
  %6 = getelementptr i8, ptr %comm, i32 0
  %7 = load i8, ptr %6, align 1
  %strcmp.cmp = icmp ne i8 %7, 115
...
strcmp.false:                                     ; preds = %strcmp.done, %strcmp.loop, %helper_merge
...
helper_failure5:                                  ; preds = %strcmp.false
  call void @llvm.lifetime.start.p0(i64 -1, ptr %helper_error_t7)
  %15 = getelementptr %helper_error_t, ptr %helper_error_t7, i64 0, i32 0
  store i64 30006, ptr %15, align 8
  %16 = getelementptr %helper_error_t, ptr %helper_error_t7, i64 0, i32 1
  store i64 1, ptr %16, align 8
  %17 = getelementptr %helper_error_t, ptr %helper_error_t7, i64 0, i32 2
...
helper_merge6:                                    ; preds = %counter_merge10, %strcmp.false
...
lookup_success14:                                 ; preds = %event_loss_counter9
  %18 = atomicrmw add ptr %lookup_elem13, i64 1 seq_cst, align 8
