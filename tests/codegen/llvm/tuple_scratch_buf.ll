...
@__bt__tuple_buf = dso_local externally_initialized global [1 x [1 x [16 x i8]]] zeroinitializer, section ".data.tuple_buf", !dbg !34
...
!35 = distinct !DIGlobalVariable(name: "__bt__tuple_buf", linkageName: "global", scope: !2, file: !2, type: !36, isLocal: false, isDefinition: true)
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !37, size: 128, elements: !29)
!37 = !DICompositeType(tag: DW_TAG_array_type, baseType: !38, size: 128, elements: !29)
