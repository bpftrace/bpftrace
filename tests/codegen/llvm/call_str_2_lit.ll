...
@stack = dso_local global %"struct map_t.3" zeroinitializer, section ".maps", !dbg !58
...
!59 = distinct !DIGlobalVariable(name: "stack", linkageName: "global", scope: !2, file: !2, type: !60, isLocal: false, isDefinition: true)
...
!64 = !DICompositeType(tag: DW_TAG_array_type, baseType: !22, size: 32768, elements: !65)
!65 = !{!66}
