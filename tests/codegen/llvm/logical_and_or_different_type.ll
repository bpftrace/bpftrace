...
@fmt_str_buf = dso_local externally_initialized global [1 x [1 x [40 x i8]]] zeroinitializer, section ".data.fmt_str_buf", !dbg !27
...
event_loss_counter:                               ; preds = %"||_merge14"
  %32 = atomicrmw add ptr @event_loss_counter, i64 1 seq_cst, align 8
