...
entry:
  ...
  %probe1 = alloca [27 x i8], align 1
  %lookup_elem_val = alloca i64, align 8
  %probe = alloca [27 x i8], align 1
  call void @llvm.lifetime.start.p0(i64 -1, ptr %probe)
  call void @llvm.memset.p0.i64(ptr align 1 %probe, i8 0, i64 27, i1 false)
  store [27 x i8] c"tracepoint:sched:sched_one\00", ptr %probe, align 1
  %lookup_elem = call ptr inttoptr (i64 1 to ptr)(ptr @AT_x, ptr %probe)
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %3 = add i64 %2, 1
  call void @llvm.lifetime.start.p0(i64 -1, ptr %probe1)
  call void @llvm.memset.p0.i64(ptr align 1 %probe1, i8 0, i64 27, i1 false)
  store [27 x i8] c"tracepoint:sched:sched_one\00", ptr %probe1, align 1
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@x_val")
  store i64 %3, ptr %"@x_val", align 8
  %update_elem = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %probe1, ptr %"@x_val", i64 0)
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %probe)
  call void @llvm.memset.p0.i64(ptr align 1 %probe, i8 0, i64 27, i1 false)
  store [27 x i8] c"tracepoint:sched:sched_two\00", ptr %probe, align 1
  %lookup_elem = call ptr inttoptr (i64 1 to ptr)(ptr @AT_x, ptr %probe)
  call void @llvm.lifetime.start.p0(i64 -1, ptr %lookup_elem_val)
  %map_lookup_cond = icmp ne ptr %lookup_elem, null
  br i1 %map_lookup_cond, label %lookup_success, label %lookup_failure
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  call void @llvm.lifetime.start.p0(i64 -1, ptr %probe1)
  call void @llvm.memset.p0.i64(ptr align 1 %probe1, i8 0, i64 27, i1 false)
  store [27 x i8] c"tracepoint:sched:sched_two\00", ptr %probe1, align 1
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@x_val")
  store i64 %3, ptr %"@x_val", align 8
  %update_elem = call i64 inttoptr (i64 2 to ptr)(ptr @AT_x, ptr %probe1, ptr %"@x_val", i64 0)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@x_val")
