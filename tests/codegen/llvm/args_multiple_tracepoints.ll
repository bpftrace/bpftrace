...
; Function Attrs: nounwind
define i64 @p4_0(ptr %0) #0 section "probes" !dbg !57 {
entry:
...
; Function Attrs: nounwind
define i64 @p5_0(ptr %0) #0 section "probes" !dbg !63 {
entry:
  %"@_val" = alloca i64, align 8
  %"@_key" = alloca i64, align 8
  %1 = call ptr @llvm.preserve.static.offset(ptr %0)
...
!57 = distinct !DISubprogram(name: "p4_0", linkageName: "p4_0", scope: !2, file: !2, type: !58, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !61)
...
!63 = distinct !DISubprogram(name: "p5_0", linkageName: "p5_0", scope: !2, file: !2, type: !58, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !64)
!64 = !{!65}
