...
; Function Attrs: nounwind
define i64 @tracepoint_sched_sched_one_1(ptr %0) #0 section "s_tracepoint_sched_sched_one_1" !dbg !50 {
entry:
...
; Function Attrs: nounwind
define i64 @tracepoint_sched_sched_one_twin_2(ptr %0) #0 section "s_tracepoint_sched_sched_one_twin_2" !dbg !56 {
entry:
  %"@_val" = alloca i64, align 8
  %"@_key" = alloca i64, align 8
  %1 = call ptr @llvm.preserve.static.offset(ptr %0)
...
!50 = distinct !DISubprogram(name: "tracepoint_sched_sched_one_1", linkageName: "tracepoint_sched_sched_one_1", scope: !2, file: !2, type: !51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !46, retainedNodes: !54)
...
!56 = distinct !DISubprogram(name: "tracepoint_sched_sched_one_twin_2", linkageName: "tracepoint_sched_sched_one_twin_2", scope: !2, file: !2, type: !51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !46, retainedNodes: !57)
!57 = !{!58}
