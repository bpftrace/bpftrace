...
lookup_fmtstr_merge:                              ; preds = %entry
  ...
  %6 = load i64, i64* %"$pp", align 8
  %7 = bitcast i64* %deref to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %7)
  %probe_read_kernel = call i64 inttoptr (i64 113 to i64 (i64*, i32, i64)*)(i64* %deref, i32 8, i64 %6)
  %8 = load i64, i64* %deref, align 8
  %9 = bitcast i64* %deref to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %9)
  %10 = bitcast i32* %deref1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %10)
  %probe_read_kernel2 = call i64 inttoptr (i64 113 to i64 (i32*, i32, i64)*)(i32* %deref1, i32 4, i64 %8)
  %11 = load i32, i32* %deref1, align 4
...
lookup_success:                                   ; preds = %event_loss_counter
  %17 = bitcast i8* %lookup_elem to i64*
