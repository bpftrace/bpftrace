...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !44
@__bt__num_cpus = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !51
...
event_loss_counter7:                              ; preds = %error_success
  ...
  %27 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded11, i64 0, i64 0
...
!52 = distinct !DIGlobalVariable(name: "__bt__num_cpus", linkageName: "global", scope: !2, file: !2, type: !27, isLocal: false, isDefinition: true)
