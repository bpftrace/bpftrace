...
define i64 @iter_task_file_1(i8* %0) section "s_iter_task_file_1" !dbg !55 {
entry:
...
lookup_success:                                   ; preds = %pred_true
  ...
  %10 = atomicrmw add i64* %cast, i64 1 seq_cst
...
!55 = distinct !DISubprogram(name: "iter_task_file_1", linkageName: "iter_task_file_1", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
