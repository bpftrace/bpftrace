...
define i64 @"iter:task_file"(i8* %0) section "s_iter:task_file_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "iter_task_file", linkageName: "iter_task_file", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
