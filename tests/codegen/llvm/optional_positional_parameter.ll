...
define i64 @BEGIN(i8* %0) section "s_BEGIN_1" !dbg !34 {
entry:
...
!34 = distinct !DISubprogram(name: "BEGIN", linkageName: "BEGIN", scope: !2, file: !2, type: !35, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !30, retainedNodes: !38)
