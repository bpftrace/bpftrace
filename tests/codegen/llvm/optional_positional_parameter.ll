...
@AT_y = dso_local global %"struct map_internal_repr_t.161" zeroinitializer, section ".maps", !dbg !22
@ringbuf = dso_local global %"struct map_internal_repr_t.162" zeroinitializer, section ".maps", !dbg !29
