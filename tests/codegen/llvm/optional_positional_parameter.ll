...
@AT_y = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !22
@ringbuf = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !29
...
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !20, size: 64, elements: !15)
