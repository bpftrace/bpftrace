...
@stack_scratch = dso_local global %"struct map_internal_repr_t.141" zeroinitializer, section ".maps", !dbg !46
@ringbuf = dso_local global %"struct map_internal_repr_t.142" zeroinitializer, section ".maps", !dbg !58
