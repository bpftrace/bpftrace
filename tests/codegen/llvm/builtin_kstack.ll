...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !72
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !79

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !85 {
entry:
...
!75 = !DICompositeType(tag: DW_TAG_array_type, baseType: !76, size: 64, elements: !15)
!76 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 64, elements: !77)
!77 = !{!78}
!78 = !DISubrange(count: 8, lowerBound: 0)
!79 = !DIGlobalVariableExpression(var: !80, expr: !DIExpression())
!80 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
...
!82 = !{!0, !7, !26, !46, !58, !72, !79}
!83 = !{i32 2, !"Debug Info Version", i32 3}
!84 = !{i32 7, !"uwtable", i32 0}
!85 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !86, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !81, retainedNodes: !89)
!86 = !DISubroutineType(types: !87)
!87 = !{!20, !88}
!88 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64)
!89 = !{!90}
!90 = !DILocalVariable(name: "ctx", arg: 1, scope: !85, file: !2, type: !88)
