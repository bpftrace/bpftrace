...
@stack_scratch = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !46
@ringbuf = dso_local global %"struct map_internal_repr_t.151" zeroinitializer, section ".maps", !dbg !58
