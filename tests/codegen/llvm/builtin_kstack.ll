...
define i64 @kprobe_f_1(ptr %0) section "s_kprobe_f_1" !dbg !85 {
entry:
...
!85 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !86, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !82, retainedNodes: !89)
