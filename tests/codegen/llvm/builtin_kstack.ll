...
@stack_scratch = dso_local global %"struct map_internal_repr_t.164" zeroinitializer, section ".maps", !dbg !46
@ringbuf = dso_local global %"struct map_internal_repr_t.165" zeroinitializer, section ".maps", !dbg !58
