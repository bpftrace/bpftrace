...
@stack_scratch = dso_local global %"struct map_internal_repr_t.162" zeroinitializer, section ".maps", !dbg !46
@ringbuf = dso_local global %"struct map_internal_repr_t.163" zeroinitializer, section ".maps", !dbg !58
