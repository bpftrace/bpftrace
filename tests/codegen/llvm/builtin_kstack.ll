...
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !72
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !74
...
!73 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
...
!77 = !DICompositeType(tag: DW_TAG_array_type, baseType: !78, size: 64, elements: !15)
