...
; Function Attrs: nounwind
declare !dbg !62 extern_weak i64 @bpf_map_sum_elem_count(ptr %0) local_unnamed_addr #0 section ".ksyms"
...
!62 = !DISubprogram(name: "bpf_map_sum_elem_count", linkageName: "bpf_map_sum_elem_count", scope: !2, file: !2, type: !63, flags: DIFlagPrototyped, spFlags: 0)
!63 = !DISubroutineType(types: !64)
!64 = !{!24, !65}
!65 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !66, size: 64)
!66 = !DICompositeType(tag: DW_TAG_structure_type, name: "bpf_map", scope: !2, file: !2, elements: !67)
!67 = !{}
