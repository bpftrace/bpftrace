...
lookup_fmtstr_merge:                              ; preds = %entry
  %3 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %4 = getelementptr %print_integer_8_t, %print_integer_8_t* %3, i64 0, i32 0
  store i64 30007, i64* %4, align 8
  %5 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %6 = getelementptr %print_integer_8_t, %print_integer_8_t* %5, i64 0, i32 1
  store i64 0, i64* %6, align 8
  %7 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %8 = getelementptr %print_integer_8_t, %print_integer_8_t* %7, i32 0, i32 2
  %9 = bitcast [8 x i8]* %8 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %9, i8 0, i64 8, i1 false)
  %10 = bitcast [8 x i8]* %8 to i64*
