...
entry:
  ...
  %ringbuf_output = call i64 inttoptr (i64 130 to i64 (%"struct map_t"*, %print_integer_8_t*, i64, i64)*)(%"struct map_t"* @ringbuf, %print_integer_8_t* %print_integer_8_t, i64 24, i64 0)
