...
@map_key_buf = dso_local externally_initialized global [1 x [7 x [8 x i8]]] zeroinitializer, section ".data.map_key_buf", !dbg !36
@write_map_val_buf = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.write_map_val_buf", !dbg !48
@max_cpu_id = dso_local externally_initialized constant i64 zeroinitializer, section ".rodata", !dbg !52
@read_map_val_buf = dso_local externally_initialized global [1 x [2 x [8 x i8]]] zeroinitializer, section ".data.read_map_val_buf", !dbg !54
@num_cpus = dso_local externally_initialized constant i64 zeroinitializer, section ".rodata", !dbg !60
...
!37 = distinct !DIGlobalVariable(name: "map_key_buf", linkageName: "global", scope: !2, file: !2, type: !38, isLocal: false, isDefinition: true)
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !39, size: 448, elements: !46)
!39 = !DICompositeType(tag: DW_TAG_array_type, baseType: !40, size: 448, elements: !44)
!40 = !DICompositeType(tag: DW_TAG_array_type, baseType: !41, size: 64, elements: !42)
!41 = !DIBasicType(name: "int8", size: 8, encoding: DW_ATE_signed)
!42 = !{!43}
!43 = !DISubrange(count: 8, lowerBound: 0)
!44 = !{!45}
!45 = !DISubrange(count: 7, lowerBound: 0)
!46 = !{!47}
!47 = !DISubrange(count: 1, lowerBound: 0)
!48 = !DIGlobalVariableExpression(var: !49, expr: !DIExpression())
!49 = distinct !DIGlobalVariable(name: "write_map_val_buf", linkageName: "global", scope: !2, file: !2, type: !50, isLocal: false, isDefinition: true)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 64, elements: !46)
!51 = !DICompositeType(tag: DW_TAG_array_type, baseType: !40, size: 64, elements: !46)
!52 = !DIGlobalVariableExpression(var: !53, expr: !DIExpression())
!53 = distinct !DIGlobalVariable(name: "max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !18, isLocal: false, isDefinition: true)
!54 = !DIGlobalVariableExpression(var: !55, expr: !DIExpression())
!55 = distinct !DIGlobalVariable(name: "read_map_val_buf", linkageName: "global", scope: !2, file: !2, type: !56, isLocal: false, isDefinition: true)
!56 = !DICompositeType(tag: DW_TAG_array_type, baseType: !57, size: 128, elements: !46)
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !40, size: 128, elements: !58)
!58 = !{!59}
!59 = !DISubrange(count: 2, lowerBound: 0)
!60 = !DIGlobalVariableExpression(var: !61, expr: !DIExpression())
!61 = distinct !DIGlobalVariable(name: "num_cpus", linkageName: "global", scope: !2, file: !2, type: !18, isLocal: false, isDefinition: true)
...
!67 = !{!18, !68}
!68 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 64)
!69 = !{!70}
