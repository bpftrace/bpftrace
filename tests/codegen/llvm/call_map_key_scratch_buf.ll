...
@ringbuf = dso_local global %"struct map_internal_repr_t.141" zeroinitializer, section ".maps", !dbg !35
...
@__bt__map_key_buf = dso_local externally_initialized global [1 x [2 x [16 x i8]]] zeroinitializer, section ".data.map_key_buf", !dbg !66
...
entry:
  ...
  %4 = getelementptr [1 x [2 x [16 x i8]]], ptr @__bt__map_key_buf, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %8 = getelementptr [1 x [2 x [16 x i8]]], ptr @__bt__map_key_buf, i64 0, i64 %cpu.id.bounded2, i64 1, i64 0
...
lookup_merge6:                                    ; preds = %lookup_failure5, %lookup_success4
  ...
  %__has_key = call i32 @__has_key(ptr @AT_x, ptr %2), !dbg !84
  %13 = sext i32 %__has_key to i64
  %14 = icmp eq i64 %13, 0
  %get_cpu_id13 = call i64 inttoptr (i64 8 to ptr)() #3
  %15 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded14 = and i64 %get_cpu_id13, %15
  %16 = getelementptr [1 x [2 x [16 x i8]]], ptr @__bt__map_key_buf, i64 0, i64 %cpu.id.bounded14, i64 2, i64 0
  store i64 1, ptr %16, align 8
  %delete_elem = call i64 inttoptr (i64 3 to ptr)(ptr @AT_x, ptr %16)
...
!68 = !DICompositeType(tag: DW_TAG_array_type, baseType: !69, size: 256, elements: !58)
!69 = !DICompositeType(tag: DW_TAG_array_type, baseType: !32, size: 256, elements: !70)
!70 = !{!71}
!71 = !DISubrange(count: 2, lowerBound: 0)
...
!84 = !DILocation(line: 330, column: 5, scope: !78)
