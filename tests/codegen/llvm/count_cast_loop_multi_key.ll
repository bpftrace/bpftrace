...
@__bt__num_cpus = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !56

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !62 {
entry:
...
!49 = !DICompositeType(tag: DW_TAG_array_type, baseType: !50, size: 64, elements: !54)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !51, size: 64, elements: !54)
...
!57 = distinct !DIGlobalVariable(name: "__bt__num_cpus", linkageName: "global", scope: !2, file: !2, type: !27, isLocal: false, isDefinition: true)
