...
define i64 @"rawtracepoint:sched_switch"(i8* %0) section "s_rawtracepoint:sched_switch_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "rawtracepoint_sched_switch", linkageName: "rawtracepoint_sched_switch", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
