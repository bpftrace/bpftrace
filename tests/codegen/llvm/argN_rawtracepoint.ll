...
define i64 @"rawtracepoint:sched_switch"(i8* %0) section "s_rawtracepoint:sched_switch_1" !dbg !55 {
entry:
...
!55 = distinct !DISubprogram(name: "rawtracepoint_sched_switch", linkageName: "rawtracepoint_sched_switch", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
