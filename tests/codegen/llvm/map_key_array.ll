...
define i64 @"kprobe:f"(i8* %0) section "s_kprobe:f_1" !dbg !55 {
entry:
  ...
  %update_elem = call i64 inttoptr (i64 2 to i64 (%"struct map_t"*, [4 x i32]*, i64*, i64)*)(%"struct map_t"* @AT_x, [4 x i32]* %"@x_key", i64* %"@x_val", i64 0)
  %6 = bitcast i64* %"@x_val" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %6)
  %7 = bitcast [4 x i32]* %"@x_key" to i8*
...
!19 = !DIBasicType(name: "int32", size: 32, encoding: DW_ATE_signed)
!20 = !{!21}
...
!55 = distinct !DISubprogram(name: "kprobe_f", linkageName: "kprobe_f", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
!56 = !DISubroutineType(types: !57)
!57 = !{!24, !58}
!58 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !59, size: 64)
!59 = !DIBasicType(name: "int8", size: 8, encoding: DW_ATE_signed)
!60 = !{!61, !62}
!61 = !DILocalVariable(name: "var0", scope: !55, file: !2, type: !24)
