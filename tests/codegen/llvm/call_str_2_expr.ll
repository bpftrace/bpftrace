...
entry:
  ...
  %12 = icmp sgt i64 %probe_read_kernel_str, 0
  br i1 %12, label %str_success, label %str_merge

str_success:                                      ; preds = %entry
  %13 = bitcast [64 x i8]* %str to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %13, i8 0, i64 64, i1 false)
  %14 = and i64 %probe_read_kernel_str, 63
  %15 = trunc i64 %14 to i32
  %probe_read_kernel = call i64 inttoptr (i64 113 to i64 ([64 x i8]*, i32, i64)*)([64 x i8]* %str, i32 %15, i64 %arg0)
  br label %str_merge
