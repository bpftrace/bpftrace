...
define i64 @BEGIN(i8* %0) section "s_BEGIN_1" !dbg !53 {
entry:
...
!53 = distinct !DISubprogram(name: "BEGIN", linkageName: "BEGIN", scope: !2, file: !2, type: !54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !49, retainedNodes: !58)
