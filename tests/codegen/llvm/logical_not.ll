...
define i64 @BEGIN_1(ptr %0) section "s_BEGIN_1" !dbg !43 {
entry:
...
!43 = distinct !DISubprogram(name: "BEGIN_1", linkageName: "BEGIN_1", scope: !2, file: !2, type: !44, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !40, retainedNodes: !48)
