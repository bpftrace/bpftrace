...
define i64 @BEGIN(i8* %0) section "s_BEGIN_1" !dbg !26 {
entry:
...
!26 = distinct !DISubprogram(name: "BEGIN", linkageName: "BEGIN", scope: !2, file: !2, type: !27, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !22, retainedNodes: !31)
