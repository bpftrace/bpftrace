...
@AT_y = dso_local global %"struct map_internal_repr_t.140" zeroinitializer, section ".maps", !dbg !23
@ringbuf = dso_local global %"struct map_internal_repr_t.141" zeroinitializer, section ".maps", !dbg !25
