...
define i64 @"kretprobe:f"(i8* %0) section "s_kretprobe:f_1" !dbg !3 {
entry:
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %retval = load volatile i64, i64* %8, align 8
...
!2 = !{}
!3 = distinct !DISubprogram(name: "kretprobe_f", linkageName: "kretprobe_f", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
