...
define i64 @"kretprobe:f"(i8* %0) section "s_kretprobe:f_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "kretprobe_f", linkageName: "kretprobe_f", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
