...
@__bt__get_str_buf = dso_local externally_initialized global [1 x [1 x [64 x i8]]] zeroinitializer, section ".data.get_str_buf", !dbg !31
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr align 1 %2, i8 -1, i64 65, i1 false)
  %3 = call ptr @llvm.preserve.static.offset(ptr %0)
  %4 = getelementptr i8, ptr %3, i64 112
  %arg0 = load volatile i64, ptr %4, align 8
  %probe_read_kernel_str = call i64 inttoptr (i64 115 to ptr)(ptr %2, i32 65, i64 %arg0)
  ret i64 0
}
...
!33 = !DICompositeType(tag: DW_TAG_array_type, baseType: !34, size: 512, elements: !27)
!34 = !DICompositeType(tag: DW_TAG_array_type, baseType: !35, size: 512, elements: !27)
!35 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 512, elements: !36)
!36 = !{!37}
!37 = !DISubrange(count: 64, lowerBound: 0)
