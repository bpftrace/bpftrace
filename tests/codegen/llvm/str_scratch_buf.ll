...
@__bt__get_str_buf = dso_local externally_initialized global [1 x [1 x [64 x i8]]] zeroinitializer, section ".data.get_str_buf", !dbg !34
...
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !37, size: 512, elements: !29)
!37 = !DICompositeType(tag: DW_TAG_array_type, baseType: !38, size: 512, elements: !29)
!38 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 512, elements: !39)
!39 = !{!40}
