...
; Function Attrs: nounwind
define i64 @fentry_vmlinux_queued_spin_lock_slowpath_1(ptr %0) #0 section "s_fentry_vmlinux_queued_spin_lock_slowpath_1" !dbg !35 {
entry:
  %__try_set_recursion = call i32 @__try_set_recursion(), !dbg !41
  %true_cond = icmp ne i32 %__try_set_recursion, 0
  br i1 %true_cond, label %left, label %right

left:                                             ; preds = %entry
  %__unset_recursion = call void @__unset_recursion(), !dbg !42
  ret i64 0
...
declare dso_local i32 @__try_set_recursion() #1

; Function Attrs: alwaysinline nounwind
declare dso_local void @__unset_recursion() #1

; Function Attrs: nounwind
define i64 @tracepoint_exceptions_page_fault_user_2(ptr %0) #0 section "s_tracepoint_exceptions_page_fault_user_2" !dbg !43 {
entry:
  ret i64 1
}
...
!35 = distinct !DISubprogram(name: "fentry_vmlinux_queued_spin_lock_slowpath_1", linkageName: "fentry_vmlinux_queued_spin_lock_slowpath_1", scope: !2, file: !2, type: !36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !31, retainedNodes: !39)
...
!41 = !DILocation(line: 1, column: 1, scope: !35)
!42 = !DILocation(line: 1, column: 34, scope: !35)
!43 = distinct !DISubprogram(name: "tracepoint_exceptions_page_fault_user_2", linkageName: "tracepoint_exceptions_page_fault_user_2", scope: !2, file: !2, type: !36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !31, retainedNodes: !44)
!44 = !{!45}
!45 = !DILocalVariable(name: "ctx", arg: 1, scope: !43, file: !2, type: !38)
