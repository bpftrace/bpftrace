...
value_is_set:                                     ; preds = %lookup_success
  %2 = atomicrmw add ptr @__bt__event_loss_counter, i64 1 seq_cst, align 8
  ret i64 0
...
; Function Attrs: nounwind
define i64 @tracepoint_exceptions_page_fault_user_2(ptr %0) #0 section "s_tracepoint_exceptions_page_fault_user_2" !dbg !54 {
entry:
  %lookup_key1 = alloca i32, align 4
  %lookup_key = alloca i32, align 4
  call void @llvm.lifetime.start.p0(i64 -1, ptr %lookup_key)
...
!54 = distinct !DISubprogram(name: "tracepoint_exceptions_page_fault_user_2", linkageName: "tracepoint_exceptions_page_fault_user_2", scope: !2, file: !2, type: !49, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !44, retainedNodes: !55)
!55 = !{!56}
