...
define i64 @uretprobe__bin_sh_f_1(i8* %0) section "s_uretprobe__bin_sh_f_1" !dbg !57 {
entry:
  ...
  store i64 %get_func_ip, i64* %3, align 8
  store i64 %2, i64* %4, align 8
  store i64 0, i64* %5, align 8
  %6 = bitcast i64* %"@x_key" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %6)
  store i64 0, i64* %"@x_key", align 8
  %update_elem = call i64 inttoptr (i64 2 to i64 (%"struct map_t"*, i64*, %usym_t*, i64)*)(%"struct map_t"* @AT_x, i64* %"@x_key", %usym_t* %usym, i64 0)
  %7 = bitcast i64* %"@x_key" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %7)
  %8 = bitcast %usym_t* %usym to i8*
...
!57 = distinct !DISubprogram(name: "uretprobe__bin_sh_f_1", linkageName: "uretprobe__bin_sh_f_1", scope: !2, file: !2, type: !58, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !61)
