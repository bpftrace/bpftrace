...
define i64 @"uretprobe:/bin/sh:f"(i8* %0) section "s_uretprobe:/bin/sh:f_1" !dbg !57 {
entry:
...
!57 = distinct !DISubprogram(name: "uretprobe__bin_sh_f", linkageName: "uretprobe__bin_sh_f", scope: !2, file: !2, type: !58, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !61)
