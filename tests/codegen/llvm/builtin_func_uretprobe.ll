...
define i64 @uretprobe__bin_sh_f_1(ptr %0) section "s_uretprobe__bin_sh_f_1" !dbg !56 {
entry:
...
!56 = distinct !DISubprogram(name: "uretprobe__bin_sh_f_1", linkageName: "uretprobe__bin_sh_f_1", scope: !2, file: !2, type: !57, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !60)
