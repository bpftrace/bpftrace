...
; Function Attrs: nounwind
define i64 @uretprobe__bin_sh_f_1(ptr %0) #0 section "s_uretprobe__bin_sh_f_1" !dbg !50 {
entry:
...
!50 = distinct !DISubprogram(name: "uretprobe__bin_sh_f_1", linkageName: "uretprobe__bin_sh_f_1", scope: !2, file: !2, type: !51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !46, retainedNodes: !54)
