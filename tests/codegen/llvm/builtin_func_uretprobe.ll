...
; Function Attrs: nounwind
define i64 @uretprobe__bin_sh_f_1(ptr %0) #0 section "s_uretprobe__bin_sh_f_1" !dbg !53 {
entry:
...
!53 = distinct !DISubprogram(name: "uretprobe__bin_sh_f_1", linkageName: "uretprobe__bin_sh_f_1", scope: !2, file: !2, type: !54, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !49, retainedNodes: !57)
