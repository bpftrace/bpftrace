...
define i64 @"kretprobe:vfs_read"(i8* %0) section "s_kretprobe:vfs_read_1" !dbg !3 {
entry:
...
lookup_merge:                                     ; preds = %lookup_failure, %lookup_success
  ...
  %27 = bitcast [16 x i8]* %comm17 to i8*
...
!2 = !{}
!3 = distinct !DISubprogram(name: "kretprobe_vfs_read", linkageName: "kretprobe_vfs_read", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
