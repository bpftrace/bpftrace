...
define i64 @"kretprobe:vfs_read"(i8* %0) section "s_kretprobe:vfs_read_1" !dbg !29 {
entry:
...
!29 = distinct !DISubprogram(name: "kretprobe_vfs_read", linkageName: "kretprobe_vfs_read", scope: !2, file: !2, type: !30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !25, retainedNodes: !33)
