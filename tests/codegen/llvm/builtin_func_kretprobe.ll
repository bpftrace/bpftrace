...
define i64 @"kretprobe:f"(i8* %0) section "s_kretprobe:f_1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kretprobe_f", linkageName: "kretprobe_f", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
