...
define i64 @kretprobe_f_1(ptr %0) section "s_kretprobe_f_1" !dbg !33 {
entry:
...
!33 = distinct !DISubprogram(name: "kretprobe_f_1", linkageName: "kretprobe_f_1", scope: !2, file: !2, type: !34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !30, retainedNodes: !38)
