...
define i64 @kretprobe_f_1(ptr %0) section "s_kretprobe_f_1" !dbg !50 {
entry:
...
!50 = distinct !DISubprogram(name: "kretprobe_f_1", linkageName: "kretprobe_f_1", scope: !2, file: !2, type: !51, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !55)
