...
define i64 @kretprobe_f_1(ptr %0) section "s_kretprobe_f_1" !dbg !45 {
entry:
...
!45 = distinct !DISubprogram(name: "kretprobe_f_1", linkageName: "kretprobe_f_1", scope: !2, file: !2, type: !46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !50)
