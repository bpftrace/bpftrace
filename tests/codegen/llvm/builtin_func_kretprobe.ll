...
; Function Attrs: nounwind
define i64 @kretprobe_f_1(ptr %0) #0 section "s_kretprobe_f_1" !dbg !49 {
entry:
...
!49 = distinct !DISubprogram(name: "kretprobe_f_1", linkageName: "kretprobe_f_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
