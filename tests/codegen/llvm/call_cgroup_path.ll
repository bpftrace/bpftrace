...
entry:
  ...
  %ringbuf_output = call i64 inttoptr (i64 130 to i64 (%"struct map_t"*, %print_cgroup_path_16_t*, i64, i64)*)(%"struct map_t"* @ringbuf, %print_cgroup_path_16_t* %print_cgroup_path_16_t, i64 32, i64 0)
