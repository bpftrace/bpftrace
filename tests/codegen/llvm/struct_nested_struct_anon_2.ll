...
entry:
  ...
  %probe_read_kernel = call i64 inttoptr (i64 113 to ptr)(ptr %"struct Foo::(unnamed at definitions.h:2:14).x", i32 4, ptr %7)
  %8 = load i32, ptr %"struct Foo::(unnamed at definitions.h:2:14).x", align 4
