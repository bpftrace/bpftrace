...
lookup_success3:                                  ; preds = %helper_merge
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %lookup_elem_val, ptr align 1 %lookup_elem2, i64 5, i1 false)
...
lookup_merge5:                                    ; preds = %lookup_failure4, %lookup_success3
  ...
  %update_elem7 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_y, ptr %"@y_key", ptr %lookup_elem_val, i64 0)
...
helper_failure8:                                  ; preds = %lookup_merge5
  ...
  %9 = getelementptr %helper_error_t, ptr %helper_error_t10, i64 0, i32 0
  store i64 30006, ptr %9, align 8
  %10 = getelementptr %helper_error_t, ptr %helper_error_t10, i64 0, i32 1
  store i64 1, ptr %10, align 8
  %11 = getelementptr %helper_error_t, ptr %helper_error_t10, i64 0, i32 2
...
lookup_success17:                                 ; preds = %event_loss_counter12
  %12 = atomicrmw add ptr %lookup_elem16, i64 1 seq_cst, align 8
