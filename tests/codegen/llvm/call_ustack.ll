...
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.164" zeroinitializer, section ".maps", !dbg !54
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.165" zeroinitializer, section ".maps", !dbg !63
@stack_scratch = dso_local global %"struct map_internal_repr_t.166" zeroinitializer, section ".maps", !dbg !65
@ringbuf = dso_local global %"struct map_internal_repr_t.167" zeroinitializer, section ".maps", !dbg !75
