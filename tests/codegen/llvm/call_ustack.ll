...
%"struct map_internal_repr_t.151" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.152" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.153" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.154" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.155" = type { ptr, ptr }
...
@AT_y = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !26
@AT_z = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !28
@stack_perf_127 = dso_local global %"struct map_internal_repr_t.151" zeroinitializer, section ".maps", !dbg !30
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.152" zeroinitializer, section ".maps", !dbg !54
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.153" zeroinitializer, section ".maps", !dbg !63
@stack_scratch = dso_local global %"struct map_internal_repr_t.154" zeroinitializer, section ".maps", !dbg !65
@ringbuf = dso_local global %"struct map_internal_repr_t.155" zeroinitializer, section ".maps", !dbg !75
