...
%"struct map_internal_repr_t.143" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.144" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.145" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.146" = type { ptr, ptr }
...
@AT_z = dso_local global %"struct map_internal_repr_t.141" zeroinitializer, section ".maps", !dbg !28
@stack_perf_127 = dso_local global %"struct map_internal_repr_t.142" zeroinitializer, section ".maps", !dbg !30
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.143" zeroinitializer, section ".maps", !dbg !54
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.144" zeroinitializer, section ".maps", !dbg !63
@stack_scratch = dso_local global %"struct map_internal_repr_t.145" zeroinitializer, section ".maps", !dbg !65
@ringbuf = dso_local global %"struct map_internal_repr_t.146" zeroinitializer, section ".maps", !dbg !75
