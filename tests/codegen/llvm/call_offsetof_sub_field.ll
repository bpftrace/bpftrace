...
helper_merge:                                     ; preds = %counter_merge, %entry
  ...
  %6 = getelementptr %exit_t, ptr %exit, i64 0, i32 0
  store i64 30000, ptr %6, align 8
  %7 = getelementptr %exit_t, ptr %exit, i64 0, i32 1
...
event_loss_counter2:                              ; preds = %helper_merge
...
counter_merge3:                                   ; preds = %lookup_merge9, %helper_merge
