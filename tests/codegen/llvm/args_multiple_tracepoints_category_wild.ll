...
; Function Attrs: nounwind
define i64 @p4_0(ptr %0) #0 section "probes" !dbg !66 {
entry:
  %"@_val" = alloca i64, align 8
  %"@_key" = alloca i64, align 8
  %1 = call ptr @llvm.preserve.static.offset(ptr %0)
...
!66 = distinct !DISubprogram(name: "p4_0", linkageName: "p4_0", scope: !2, file: !2, type: !58, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !53, retainedNodes: !67)
!67 = !{!68}
