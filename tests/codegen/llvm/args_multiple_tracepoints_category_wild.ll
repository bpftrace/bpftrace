...
; Function Attrs: nounwind
define i64 @tracepoint_sched_sched_one_1(ptr %0) #0 section "s_tracepoint_sched_sched_one_1" !dbg !46 {
entry:
...
; Function Attrs: nounwind
define i64 @tracepoint_sched_sched_two_1(ptr %0) #0 section "s_tracepoint_sched_sched_two_1" !dbg !52 {
entry:
  %"@_val" = alloca i64, align 8
  %"@_key" = alloca i64, align 8
  %1 = call ptr @llvm.preserve.static.offset(ptr %0)
...
; Function Attrs: nounwind
define i64 @tracepoint_sched_extra_sched_extra_1(ptr %0) #0 section "s_tracepoint_sched_extra_sched_extra_1" !dbg !55 {
entry:
  %"@_val" = alloca i64, align 8
  %"@_key" = alloca i64, align 8
  %1 = call ptr @llvm.preserve.static.offset(ptr %0)
...
!41 = distinct !DIGlobalVariable(name: "__bt__event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !24, isLocal: false, isDefinition: true)
...
!46 = distinct !DISubprogram(name: "tracepoint_sched_sched_one_1", linkageName: "tracepoint_sched_sched_one_1", scope: !2, file: !2, type: !47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !50)
...
!52 = distinct !DISubprogram(name: "tracepoint_sched_sched_two_1", linkageName: "tracepoint_sched_sched_two_1", scope: !2, file: !2, type: !47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !53)
!53 = !{!54}
!54 = !DILocalVariable(name: "ctx", arg: 1, scope: !52, file: !2, type: !49)
!55 = distinct !DISubprogram(name: "tracepoint_sched_extra_sched_extra_1", linkageName: "tracepoint_sched_extra_sched_extra_1", scope: !2, file: !2, type: !47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !56)
!56 = !{!57}
!57 = !DILocalVariable(name: "ctx", arg: 1, scope: !55, file: !2, type: !49)
