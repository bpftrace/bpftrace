...
define i64 @"tracepoint:sched:sched_two"(i8* %0) section "s_tracepoint:sched:sched_two_1" !dbg !63 {
entry:
  %initial_value = alloca i64, align 8
  %lookup_elem_val = alloca i64, align 8
  %"@_key" = alloca i64, align 8
...
define i64 @"tracepoint:sched_extra:sched_extra"(i8* %0) section "s_tracepoint:sched_extra:sched_extra_1" !dbg !67 {
entry:
  %initial_value = alloca i64, align 8
  %lookup_elem_val = alloca i64, align 8
  %"@_key" = alloca i64, align 8
...
!67 = distinct !DISubprogram(name: "tracepoint_sched_extra_sched_extra", linkageName: "tracepoint_sched_extra_sched_extra", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !68)
!68 = !{!69, !70}
!69 = !DILocalVariable(name: "var0", scope: !67, file: !2, type: !18)
!70 = !DILocalVariable(name: "var1", arg: 1, scope: !67, file: !2, type: !58)
