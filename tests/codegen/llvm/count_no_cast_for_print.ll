...
lookup_merge:                                     ; preds = %helper_merge, %lookup_success
  ...
  %ringbuf_output6 = call i64 inttoptr (i64 130 to ptr)(ptr @ringbuf, ptr %"print_@", i64 20, i64 0)
...
event_loss_counter7:                              ; preds = %lookup_merge
...
counter_merge8:                                   ; preds = %lookup_merge14, %lookup_merge
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"print_@")
  ret i64 0

lookup_success12:                                 ; preds = %event_loss_counter7
  %13 = atomicrmw add ptr %lookup_elem11, i64 1 seq_cst, align 8
