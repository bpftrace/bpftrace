...
!17 = !DICompositeType(tag: DW_TAG_structure_type, scope: !2, file: !2, size: 256, elements: !18)
!18 = !{!19, !21, !25}
!19 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !20, size: 8)
!20 = !DIBasicType(name: "int8", size: 8, encoding: DW_ATE_signed)
!21 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !22, size: 128, offset: 8)
!22 = !DICompositeType(tag: DW_TAG_array_type, baseType: !20, size: 128, elements: !23)
!23 = !{!24}
!24 = !DISubrange(count: 16, lowerBound: 0)
!25 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !14, size: 64, offset: 192)
...
!45 = !{!14, !46}
!46 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
!47 = !{!48}
