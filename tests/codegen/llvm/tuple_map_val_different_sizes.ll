...
entry:
  ...
  %6 = getelementptr [1 x [1 x [24 x i8]]], ptr @write_map_val_buf, i64 0, i64 %cpuid.min.select3, i64 0, i64 0
  ...
  %cpuid.min.cmp6 = icmp ule i64 %get_cpu_id5, %11
  %cpuid.min.select7 = select i1 %cpuid.min.cmp6, i64 %get_cpu_id5, i64 %11
  %12 = getelementptr [1 x [2 x [24 x i8]]], ptr @tuple_buf, i64 0, i64 %cpuid.min.select7, i64 1, i64 0
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %14, ptr align 1 %str4, i64 13, i1 false)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %str4)
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"@a_key8")
  store i64 0, ptr %"@a_key8", align 8
  %update_elem9 = call i64 inttoptr (i64 2 to ptr)(ptr @AT_a, ptr %"@a_key8", ptr %12, i64 0)
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@a_key8")
  ret i64 0
}
