...
; Function Attrs: nounwind
define i64 @p1_0(ptr %0) #0 section "probes" !dbg !60 {
entry:
...
lookup_success:                                   ; preds = %event_loss_counter
  %56 = atomicrmw add ptr %lookup_elem, i64 1 seq_cst, align 8
...
!60 = distinct !DISubprogram(name: "p1_0", linkageName: "p1_0", scope: !2, file: !2, type: !61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !56, retainedNodes: !64)
