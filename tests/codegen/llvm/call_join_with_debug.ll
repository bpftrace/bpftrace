...
event_loss_counter:                               ; preds = %lookup_join_merge
  ...
  %57 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
!52 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !53, isLocal: false, isDefinition: true)
!53 = !DIBasicType(name: "int64", size: 64, encoding: DW_ATE_signed)
