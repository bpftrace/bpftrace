...
lookup_fmtstr_merge:                              ; preds = %entry
  ...
  %3 = bitcast i8* %lookup_fmtstr_map to %system_t*
  %4 = getelementptr %system_t, %system_t* %3, i32 0, i32 0
  store i64 10000, i64* %4, align 8
  %5 = bitcast i8* %lookup_fmtstr_map to %system_t*
  %6 = getelementptr %system_t, %system_t* %5, i32 0, i32 1
