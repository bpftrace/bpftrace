...
@elapsed = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !22
@ringbuf = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !24
...
; Function Attrs: nounwind
define i64 @interval_s_1_1(ptr %0) #0 section "s_interval_s_1_1" !dbg !48 {
entry:
...
!23 = distinct !DIGlobalVariable(name: "elapsed", linkageName: "global", scope: !2, file: !2, type: !9, isLocal: false, isDefinition: true)
...
!48 = distinct !DISubprogram(name: "interval_s_1_1", linkageName: "interval_s_1_1", scope: !2, file: !2, type: !49, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !44, retainedNodes: !52)
