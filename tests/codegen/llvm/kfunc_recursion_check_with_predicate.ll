...
lookup_success8:                                  ; preds = %pred_false
  %14 = bitcast i32* %lookup_key6 to i8*
...
lookup_fmtstr_merge:                              ; preds = %pred_true
  %15 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %16 = getelementptr %print_integer_8_t, %print_integer_8_t* %15, i64 0, i32 0
  store i64 30007, i64* %16, align 8
  %17 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %18 = getelementptr %print_integer_8_t, %print_integer_8_t* %17, i64 0, i32 1
  store i64 0, i64* %18, align 8
  %19 = bitcast i8* %lookup_fmtstr_map to %print_integer_8_t*
  %20 = getelementptr %print_integer_8_t, %print_integer_8_t* %19, i32 0, i32 2
  %21 = bitcast [8 x i8]* %20 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 1 %21, i8 0, i64 8, i1 false)
...
counter_merge:                                    ; preds = %lookup_merge17, %lookup_fmtstr_merge
  %24 = bitcast i32* %lookup_key19 to i8*
...
lookup_success15:                                 ; preds = %event_loss_counter
  %25 = bitcast i8* %lookup_elem14 to i64*
