...
%"struct map_internal_repr_t.153" = type { ptr, ptr }
...
@AT_b = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !22
@AT_c = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !24
@AT_d = dso_local global %"struct map_internal_repr_t.151" zeroinitializer, section ".maps", !dbg !26
@AT_e = dso_local global %"struct map_internal_repr_t.152" zeroinitializer, section ".maps", !dbg !28
@ringbuf = dso_local global %"struct map_internal_repr_t.153" zeroinitializer, section ".maps", !dbg !37
