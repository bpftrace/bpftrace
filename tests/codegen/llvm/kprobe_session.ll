...
; Function Attrs: nounwind
define i64 @kprobe_sys___1(ptr %0) #0 section "s_kprobe_sys___1" !dbg !49 {
entry:
...
; Function Attrs: nounwind
declare !dbg !55 extern_weak i8 @bpf_session_is_return() local_unnamed_addr #0 section ".ksyms"
...
!49 = distinct !DISubprogram(name: "kprobe_sys___1", linkageName: "kprobe_sys___1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
...
!55 = !DISubprogram(name: "bpf_session_is_return", linkageName: "bpf_session_is_return", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: 0)
