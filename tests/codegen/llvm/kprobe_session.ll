...
; Function Attrs: nounwind
define i64 @kprobe_sys___1(ptr %0) #0 section "s_kprobe_sys___1" !dbg !42 {
entry:
...
; Function Attrs: nounwind
declare !dbg !48 extern_weak i8 @bpf_session_is_return() local_unnamed_addr #0 section ".ksyms"
...
!42 = distinct !DISubprogram(name: "kprobe_sys___1", linkageName: "kprobe_sys___1", scope: !2, file: !2, type: !43, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !38, retainedNodes: !46)
...
!48 = !DISubprogram(name: "bpf_session_is_return", linkageName: "bpf_session_is_return", scope: !2, file: !2, type: !49, flags: DIFlagPrototyped, spFlags: 0)
