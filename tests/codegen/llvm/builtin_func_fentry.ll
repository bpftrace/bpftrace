...
; Function Attrs: nounwind
define i64 @fentry_mock_vmlinux_f_1(ptr %0) #0 section "s_fentry_mock_vmlinux_f_1" !dbg !49 {
entry:
  ...
  store i64 %get_func_ip, ptr %"@x_val", align 8
...
!49 = distinct !DISubprogram(name: "fentry_mock_vmlinux_f_1", linkageName: "fentry_mock_vmlinux_f_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
