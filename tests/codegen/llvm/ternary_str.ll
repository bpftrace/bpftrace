...
right:                                            ; preds = %entry
  ...
  %15 = bitcast [64 x i8]* %"@x_val" to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %15)
  store [64 x i8]* %buf, [64 x i8]* %"@x_val", align 8
  %update_elem = call i64 inttoptr (i64 2 to i64 (%"struct map_t"*, i64*, [64 x i8]*, i64)*)(%"struct map_t"* @AT_x, i64* %"@x_key", [64 x i8]* %"@x_val", i64 0)
  %16 = bitcast [64 x i8]* %"@x_val" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %16)
  %17 = bitcast i64* %"@x_key" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %17)
  %18 = bitcast [64 x i8]* %buf to i8*
