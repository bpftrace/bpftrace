...
@stack = dso_local global %"struct map_t.2" zeroinitializer, section ".maps", !dbg !52
...
entry:
  ...
  %1 = getelementptr [24 x i8], ptr %"@x_key", i64 0, i64 0
  store i64 11, ptr %1, align 8
  %2 = getelementptr [24 x i8], ptr %"@x_key", i64 0, i64 8
  store i64 22, ptr %2, align 8
  %3 = getelementptr [24 x i8], ptr %"@x_key", i64 0, i64 16
...
!53 = distinct !DIGlobalVariable(name: "stack", linkageName: "global", scope: !2, file: !2, type: !54, isLocal: false, isDefinition: true)
...
!58 = !DICompositeType(tag: DW_TAG_array_type, baseType: !8, size: 192, elements: !59)
!59 = !{!60}
!60 = !DISubrange(count: 6, lowerBound: 0)
!61 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !2, file: !2, baseType: !62, size: 64, offset: 192)
!62 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !63, size: 64)
!63 = !DICompositeType(tag: DW_TAG_array_type, baseType: !19, size: 32768, elements: !14)
