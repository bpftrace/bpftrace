...
%"struct map_internal_repr_t.167" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.168" = type { ptr, ptr, ptr, ptr }
%"struct map_internal_repr_t.169" = type { ptr, ptr }
%kstack_key = type { i64, i64 }

@LICENSE = global [4 x i8] c"GPL\00", section "license", !dbg !0
@AT_x = dso_local global %"struct map_internal_repr_t" zeroinitializer, section ".maps", !dbg !7
@AT_y = dso_local global %"struct map_internal_repr_t.163" zeroinitializer, section ".maps", !dbg !26
@AT_z = dso_local global %"struct map_internal_repr_t.164" zeroinitializer, section ".maps", !dbg !28
@stack_perf_127 = dso_local global %"struct map_internal_repr_t.165" zeroinitializer, section ".maps", !dbg !30
@stack_bpftrace_6 = dso_local global %"struct map_internal_repr_t.166" zeroinitializer, section ".maps", !dbg !50
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.167" zeroinitializer, section ".maps", !dbg !59
@stack_scratch = dso_local global %"struct map_internal_repr_t.168" zeroinitializer, section ".maps", !dbg !61
@ringbuf = dso_local global %"struct map_internal_repr_t.169" zeroinitializer, section ".maps", !dbg !71
