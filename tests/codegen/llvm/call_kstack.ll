...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !85
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !92

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !98 {
entry:
...
!88 = !DICompositeType(tag: DW_TAG_array_type, baseType: !89, size: 64, elements: !15)
!89 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 64, elements: !90)
!90 = !{!91}
!91 = !DISubrange(count: 8, lowerBound: 0)
!92 = !DIGlobalVariableExpression(var: !93, expr: !DIExpression())
!93 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
...
!95 = !{!0, !7, !26, !28, !30, !50, !59, !61, !71, !85, !92}
!96 = !{i32 2, !"Debug Info Version", i32 3}
!97 = !{i32 7, !"uwtable", i32 0}
!98 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !99, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !94, retainedNodes: !102)
