...
; Function Attrs: nounwind
define internal i64 @map_for_each_cb.1(ptr %0, ptr %1, ptr %2, ptr %3) #0 section ".text" !dbg !67 {
for_body:
  %"$var" = alloca i64, align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"$var")
  store i64 0, ptr %"$var", align 8
...
!67 = distinct !DISubprogram(name: "map_for_each_cb_1", linkageName: "map_for_each_cb_1", scope: !2, file: !2, type: !60, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !49, retainedNodes: !68)
!68 = !{!69, !70, !71, !72}
!69 = !DILocalVariable(name: "map", arg: 1, scope: !67, file: !2, type: !56)
!70 = !DILocalVariable(name: "key", arg: 2, scope: !67, file: !2, type: !56)
!71 = !DILocalVariable(name: "value", arg: 3, scope: !67, file: !2, type: !56)
!72 = !DILocalVariable(name: "ctx", arg: 4, scope: !67, file: !2, type: !56)
