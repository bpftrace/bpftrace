...
while_cond:                                       ; preds = %arraycmp.loop, %entry
  ...
  br i1 %size_check, label %while_body, label %arraycmp.done, !llvm.loop !44
...
event_loss_counter:                               ; preds = %if_body
  ...
  %32 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
