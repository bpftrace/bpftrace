...
lookup_success:                                   ; preds = %entry
  ...
  %5 = icmp sge i64 %4, %2
  br i1 %5, label %min_max.ge, label %lookup_merge
...
lookup_merge:                                     ; preds = %lookup_failure, %min_max.ge, %lookup_success
...
min_max.ge:                                       ; preds = %lookup_success
  %10 = atomicrmw xchg i64* %cast, i64 %2 seq_cst
  br label %lookup_merge
}
