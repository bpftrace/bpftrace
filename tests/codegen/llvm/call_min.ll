...
is_set_lookup_success:                            ; preds = %mm_lookup_success
  ...
  %4 = load i64, i64* %is_set_cast, align 8
...
lookup_failure:                                   ; preds = %mm_lookup_success, %entry
  ...
  store i64 %3, i64* %initial_value, align 8
  ...
  %8 = bitcast i64* %initial_value3 to i8*
