...
strcontains.inner.cmp:                            ; preds = %strcontains.inner.notnull
  ...
  %17 = icmp ne i8 %16, %11
  %18 = or i1 %14, %17
  br i1 %18, label %strcontains.outer.incr, label %strcontains.inner.incr

strcontains.inner.incr:                           ; preds = %strcontains.inner.cmp
  %19 = load i64, ptr %strcontains.j, align 8
  %20 = add i64 %19, 1
  store i64 %20, ptr %strcontains.j, align 8
  br label %strcontains.inner.cond

strcontains.outer.incr:                           ; preds = %strcontains.inner.cmp, %strcontains.inner.notnull, %strcontains.inner.cond
  %21 = load i64, ptr %strcontains.i, align 8
  %22 = add i64 %21, 1
  store i64 %22, ptr %strcontains.i, align 8
