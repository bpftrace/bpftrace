...
; Function Attrs: nounwind
define i64 @tracepoint_syscalls_sys_enter_openat_1(ptr %0) #0 section "s_tracepoint_syscalls_sys_enter_openat_1" !dbg !49 {
entry:
...
pred_true:                                        ; preds = %entry
  ...
  store i64 %get_cgroup_id1, ptr %"@x_val", align 8
...
!49 = distinct !DISubprogram(name: "tracepoint_syscalls_sys_enter_openat_1", linkageName: "tracepoint_syscalls_sys_enter_openat_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
