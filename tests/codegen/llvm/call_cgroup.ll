...
define i64 @"tracepoint:syscalls:sys_enter_openat"(i8* %0) section "s_tracepoint:syscalls:sys_enter_openat_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "tracepoint_syscalls_sys_enter_openat", linkageName: "tracepoint_syscalls_sys_enter_openat", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
