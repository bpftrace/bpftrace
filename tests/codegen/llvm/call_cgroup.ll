...
define i64 @tracepoint_syscalls_sys_enter_openat_1(ptr %0) section "s_tracepoint_syscalls_sys_enter_openat_1" !dbg !45 {
entry:
...
helper_failure:                                   ; preds = %pred_true
...
helper_merge:                                     ; preds = %counter_merge, %pred_true
...
!45 = distinct !DISubprogram(name: "tracepoint_syscalls_sys_enter_openat_1", linkageName: "tracepoint_syscalls_sys_enter_openat_1", scope: !2, file: !2, type: !46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !50)
