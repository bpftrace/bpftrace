...
define i64 @"tracepoint:syscalls:sys_enter_openat"(i8* %0) section "s_tracepoint:syscalls:sys_enter_openat_1" !dbg !3 {
entry:
...
!2 = !{}
!3 = distinct !DISubprogram(name: "tracepoint_syscalls_sys_enter_openat", linkageName: "tracepoint_syscalls_sys_enter_openat", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
