...
@AT_x = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !31
@ringbuf = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !43
