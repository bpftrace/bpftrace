...
; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !49 {
entry:
...
event_loss_counter:                               ; preds = %lookup_failure
  ...
  %10 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
helper_merge:                                     ; preds = %counter_merge4, %lookup_merge
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@_newval")
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"@_key")
  ret i64 0

event_loss_counter3:                              ; preds = %helper_failure
  %get_cpu_id6 = call i64 inttoptr (i64 8 to ptr)() #2
  %16 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded7 = and i64 %get_cpu_id6, %16
  %17 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded7, i64 0, i64 0
...
!49 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
