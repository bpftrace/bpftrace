...
helper_failure:                                   ; preds = %lookup_merge
  %19 = bitcast %helper_error_t* %helper_error_t6 to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %19)
  %20 = getelementptr %helper_error_t, %helper_error_t* %helper_error_t6, i64 0, i32 0
  store i64 30006, i64* %20, align 8
  %21 = getelementptr %helper_error_t, %helper_error_t* %helper_error_t6, i64 0, i32 1
  store i64 1, i64* %21, align 8
  %22 = getelementptr %helper_error_t, %helper_error_t* %helper_error_t6, i64 0, i32 2
  store i32 %12, i32* %22, align 4
  %ringbuf_output7 = call i64 inttoptr (i64 130 to i64 (%"struct map_t.0"*, %helper_error_t*, i64, i64)*)(%"struct map_t.0"* @ringbuf, %helper_error_t* %helper_error_t6, i64 20, i64 0)
...
event_loss_counter8:                              ; preds = %helper_failure
  %25 = bitcast i32* %key11 to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %25)
  store i32 0, i32* %key11, align 4
  %lookup_elem12 = call i8* inttoptr (i64 1 to i8* (%"struct map_t.1"*, i32*)*)(%"struct map_t.1"* @ringbuf_loss_counter, i32* %key11)
  %map_lookup_cond16 = icmp ne i8* %lookup_elem12, null
  br i1 %map_lookup_cond16, label %lookup_success13, label %lookup_failure14

counter_merge9:                                   ; preds = %lookup_merge15, %helper_failure
  %26 = bitcast %helper_error_t* %helper_error_t6 to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %26)
  br label %helper_merge

lookup_success13:                                 ; preds = %event_loss_counter8
  %27 = bitcast i8* %lookup_elem12 to i64*
