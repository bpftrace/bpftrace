...
@process_counts = external global i64, section ".ksyms", !dbg !42
...
!43 = distinct !DIGlobalVariable(name: "process_counts", linkageName: "global", scope: !2, file: !2, type: !41, isLocal: false, isDefinition: true)
