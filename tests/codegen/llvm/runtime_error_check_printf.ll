...
; Function Attrs: nounwind
define i64 @iter_task_file_1(ptr %0) #0 section "s_iter_task_file_1" !dbg !38 {
entry:
...
event_loss_counter:                               ; preds = %helper_failure
  ...
  %11 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
!38 = distinct !DISubprogram(name: "iter_task_file_1", linkageName: "iter_task_file_1", scope: !2, file: !2, type: !39, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !34, retainedNodes: !42)
