...
@ringbuf = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !28
...
entry:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %"$var", ptr align 1 %__builtin_comm, i64 16, i1 false)
