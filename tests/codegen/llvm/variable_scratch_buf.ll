...
@__bt__var_buf = dso_local externally_initialized global [1 x [2 x [8 x i8]]] zeroinitializer, section ".data.var_buf", !dbg !34
...
!35 = distinct !DIGlobalVariable(name: "__bt__var_buf", linkageName: "global", scope: !2, file: !2, type: !36, isLocal: false, isDefinition: true)
!36 = !DICompositeType(tag: DW_TAG_array_type, baseType: !37, size: 128, elements: !29)
!37 = !DICompositeType(tag: DW_TAG_array_type, baseType: !26, size: 128, elements: !38)
!38 = !{!39}
