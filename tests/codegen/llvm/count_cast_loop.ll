...
lookup_merge:                                     ; preds = %helper_merge, %lookup_success
  ...
  %5 = trunc i64 %for_each_map_elem to i32
  %6 = icmp sge i32 %5, 0
  br i1 %6, label %helper_merge7, label %helper_failure6
...
lookup_success2:                                  ; preds = %event_loss_counter
  %10 = atomicrmw add ptr %lookup_elem1, i64 1 seq_cst, align 8
...
helper_failure6:                                  ; preds = %lookup_merge
  ...
  %11 = getelementptr %helper_error_t, ptr %helper_error_t8, i64 0, i32 0
  store i64 30006, ptr %11, align 8
  %12 = getelementptr %helper_error_t, ptr %helper_error_t8, i64 0, i32 1
  store i64 2, ptr %12, align 8
  %13 = getelementptr %helper_error_t, ptr %helper_error_t8, i64 0, i32 2
...
lookup_success15:                                 ; preds = %event_loss_counter10
  %14 = atomicrmw add ptr %lookup_elem14, i64 1 seq_cst, align 8
...
!65 = !{!18, !59, !59, !59, !59}
!66 = !{!67, !68, !69, !70}
!67 = !DILocalVariable(name: "map", arg: 1, scope: !63, file: !2, type: !59)
!68 = !DILocalVariable(name: "key", arg: 2, scope: !63, file: !2, type: !59)
!69 = !DILocalVariable(name: "value", arg: 3, scope: !63, file: !2, type: !59)
!70 = !DILocalVariable(name: "ctx", arg: 4, scope: !63, file: !2, type: !59)
