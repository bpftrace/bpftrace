...
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !47, size: 64, elements: !51)
!47 = !DICompositeType(tag: DW_TAG_array_type, baseType: !48, size: 64, elements: !51)
...
!54 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !29, isLocal: false, isDefinition: true)
