...
!45 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !29, isLocal: false, isDefinition: true)
...
!48 = !DICompositeType(tag: DW_TAG_array_type, baseType: !49, size: 64, elements: !53)
!49 = !DICompositeType(tag: DW_TAG_array_type, baseType: !50, size: 64, elements: !53)
