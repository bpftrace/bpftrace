...
define i64 @"kfunc:mock_vmlinux:tcp_sendmsg"(i8* %0) section "s_kfunc:mock_vmlinux:tcp_sendmsg_1" !dbg !55 {
entry:
...
!55 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_tcp_sendmsg", linkageName: "kfunc_mock_vmlinux_tcp_sendmsg", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
