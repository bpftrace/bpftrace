...
define i64 @"kfunc:mock_vmlinux:tcp_sendmsg"(i8* %0) section "s_kfunc:mock_vmlinux:tcp_sendmsg_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_tcp_sendmsg", linkageName: "kfunc_mock_vmlinux_tcp_sendmsg", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
