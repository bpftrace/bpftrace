...
define i64 @kfunc_mock_vmlinux_tcp_sendmsg_1(i8* %0) section "s_kfunc_mock_vmlinux_tcp_sendmsg_1" !dbg !55 {
entry:
...
lookup_success:                                   ; preds = %entry
  ...
  %10 = atomicrmw add i64* %cast1, i64 1 seq_cst
...
!55 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_tcp_sendmsg_1", linkageName: "kfunc_mock_vmlinux_tcp_sendmsg_1", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
