...
define i64 @kfunc_mock_vmlinux_tcp_sendmsg_1(ptr %0) section "s_kfunc_mock_vmlinux_tcp_sendmsg_1" !dbg !60 {
entry:
  ...
  %9 = getelementptr [1 x [1 x [8 x i8]]], ptr @write_map_val_buf, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
  store i64 1, ptr %9, align 8
  %update_elem = call i64 inttoptr (i64 2 to ptr)(ptr @AT_, ptr %"@_key", ptr %9, i64 0)
...
!60 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_tcp_sendmsg_1", linkageName: "kfunc_mock_vmlinux_tcp_sendmsg_1", scope: !2, file: !2, type: !61, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !57, retainedNodes: !64)
