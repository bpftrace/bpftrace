...
define i64 @kfunc_mock_vmlinux_tcp_sendmsg_1(ptr %0) section "s_kfunc_mock_vmlinux_tcp_sendmsg_1" !dbg !63 {
entry:
...
!63 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_tcp_sendmsg_1", linkageName: "kfunc_mock_vmlinux_tcp_sendmsg_1", scope: !2, file: !2, type: !64, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !60, retainedNodes: !67)
