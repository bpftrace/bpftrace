...
helper_merge:                                     ; preds = %counter_merge, %entry
  ...
  %10 = trunc i64 %update_elem1 to i32
  %11 = icmp sge i32 %10, 0
  br i1 %11, label %helper_merge3, label %helper_failure2
...
helper_failure2:                                  ; preds = %helper_merge
  ...
  %13 = getelementptr %helper_error_t, ptr %helper_error_t4, i64 0, i32 0
  store i64 30006, ptr %13, align 8
  %14 = getelementptr %helper_error_t, ptr %helper_error_t4, i64 0, i32 1
  store i64 1, ptr %14, align 8
  %15 = getelementptr %helper_error_t, ptr %helper_error_t4, i64 0, i32 2
...
lookup_success11:                                 ; preds = %event_loss_counter6
  %16 = atomicrmw add ptr %lookup_elem10, i64 1 seq_cst, align 8
