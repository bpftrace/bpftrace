...
define i64 @kprobe_do_execve__1(i8* %0) section "s_kprobe_do_execve__1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kprobe_do_execve__1", linkageName: "kprobe_do_execve__1", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
