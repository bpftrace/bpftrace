...
; Function Attrs: nounwind
define i64 @kprobe_sys___1(ptr %0) #0 section "s_kprobe_sys___1" !dbg !46 {
entry:
  ...
  store i64 %__builtin_func, ptr %"@x_val", align 8
...
!46 = distinct !DISubprogram(name: "kprobe_sys___1", linkageName: "kprobe_sys___1", scope: !2, file: !2, type: !47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !50)
