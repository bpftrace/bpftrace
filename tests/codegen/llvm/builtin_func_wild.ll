...
define i64 @"kprobe:do_execve*"(i8* %0) section "s_kprobe:do_execve*_1" !dbg !3 {
entry:
...
!2 = !{}
!3 = distinct !DISubprogram(name: "kprobe_do_execve_", linkageName: "kprobe_do_execve_", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
