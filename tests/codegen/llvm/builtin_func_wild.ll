...
define i64 @"kprobe:do_execve*"(i8* %0) section "s_kprobe:do_execve*_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "kprobe_do_execve_", linkageName: "kprobe_do_execve_", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
