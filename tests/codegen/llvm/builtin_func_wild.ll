...
define i64 @"kprobe:do_execve*"(i8* %0) section "s_kprobe:do_execve*_1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kprobe_do_execve_", linkageName: "kprobe_do_execve_", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
