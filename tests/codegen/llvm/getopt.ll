...
@hello = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !25

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !31 {
entry:
...
!26 = distinct !DIGlobalVariable(name: "hello", linkageName: "global", scope: !2, file: !2, type: !24, isLocal: false, isDefinition: true)
...
!31 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !27, retainedNodes: !35)
