...
@hello = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !34
...
!35 = distinct !DIGlobalVariable(name: "hello", linkageName: "global", scope: !2, file: !2, type: !33, isLocal: false, isDefinition: true)
