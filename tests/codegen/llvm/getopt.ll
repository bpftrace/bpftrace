...
@hello = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !31

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !37 {
entry:
  %"$x" = alloca i64, align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"$x")
  store i64 0, ptr %"$x", align 8
  %hello = load i64, ptr @hello, align 8
  store i64 %hello, ptr %"$x", align 8
  ret i64 0
}
...
!32 = distinct !DIGlobalVariable(name: "hello", linkageName: "global", scope: !2, file: !2, type: !26, isLocal: false, isDefinition: true)
!33 = distinct !DICompileUnit(language: DW_LANG_C, file: !2, producer: "bpftrace", isOptimized: false, runtimeVersion: 0, emissionKind: LineTablesOnly, globals: !34)
!34 = !{!0, !7, !22, !29, !31}
!35 = !{i32 2, !"Debug Info Version", i32 3}
!36 = !{i32 7, !"uwtable", i32 0}
!37 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !38, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !33, retainedNodes: !41)
!38 = !DISubroutineType(types: !39)
!39 = !{!26, !40}
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 64)
!41 = !{!42}
!42 = !DILocalVariable(name: "ctx", arg: 1, scope: !37, file: !2, type: !40)
