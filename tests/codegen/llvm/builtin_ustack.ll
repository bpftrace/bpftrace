...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !78
...
!79 = distinct !DIGlobalVariable(name: "__bt__event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !80, isLocal: false, isDefinition: true)
!80 = !DICompositeType(tag: DW_TAG_array_type, baseType: !81, size: 64, elements: !15)
!81 = !DICompositeType(tag: DW_TAG_array_type, baseType: !82, size: 64, elements: !15)
!82 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 64, elements: !83)
!83 = !{!84}
!84 = !DISubrange(count: 8, lowerBound: 0)
