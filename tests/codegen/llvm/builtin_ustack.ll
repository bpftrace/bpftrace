...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.163" zeroinitializer, section ".maps", !dbg !26
@stack_scratch = dso_local global %"struct map_internal_repr_t.164" zeroinitializer, section ".maps", !dbg !50
@ringbuf = dso_local global %"struct map_internal_repr_t.165" zeroinitializer, section ".maps", !dbg !62
