...
%"struct map_internal_repr_t.162" = type { ptr, ptr, ptr, ptr }
...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.161" zeroinitializer, section ".maps", !dbg !26
@stack_scratch = dso_local global %"struct map_internal_repr_t.162" zeroinitializer, section ".maps", !dbg !50
@ringbuf = dso_local global %"struct map_internal_repr_t.163" zeroinitializer, section ".maps", !dbg !62
