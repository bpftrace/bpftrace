...
%"struct map_internal_repr_t.142" = type { ptr, ptr }
...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.140" zeroinitializer, section ".maps", !dbg !26
@stack_scratch = dso_local global %"struct map_internal_repr_t.141" zeroinitializer, section ".maps", !dbg !50
@ringbuf = dso_local global %"struct map_internal_repr_t.142" zeroinitializer, section ".maps", !dbg !62
