...
@stack_scratch = dso_local global %"struct map_internal_repr_t.1" zeroinitializer, section ".maps", !dbg !50
@ringbuf = dso_local global %"struct map_internal_repr_t.2" zeroinitializer, section ".maps", !dbg !62
