...
entry:
  ...
  %. = select i1 %2, i8 108, i8 104
  %.128 = select i1 %2, i8 111, i8 105
  store i8 %., i8* %1, align 1
  %str1.sroa.4.0..sroa_idx = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i64 0, i64 1
  store i8 %.128, i8* %str1.sroa.4.0..sroa_idx, align 1
  %str1.sroa.5.0..sroa_idx = getelementptr inbounds [64 x i8], [64 x i8]* %buf, i64 0, i64 2
  call void @llvm.memset.p0i8.i64(i8* nonnull align 1 dereferenceable(61) %str1.sroa.5.0..sroa_idx, i8 0, i64 61, i1 false)
