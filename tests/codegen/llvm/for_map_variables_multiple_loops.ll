...
@stack = dso_local global %"struct map_t.2" zeroinitializer, section ".maps", !dbg !47
...
entry:
  ...
  %"ctx.$var12" = getelementptr %ctx_t.3, ptr %ctx1, i64 0, i32 0
  store ptr %"$var1", ptr %"ctx.$var12", align 8
  %"ctx.$var2" = getelementptr %ctx_t.3, ptr %ctx1, i64 0, i32 1
...
define internal i64 @map_for_each_cb.1(ptr %0, ptr %1, ptr %2, ptr %3) section ".text" !dbg !72 {
  %"$_" = alloca %"unsigned int64_int64__tuple_t", align 8
  %key = load i64, ptr %1, align 8
  %val = load i64, ptr %2, align 8
  call void @llvm.lifetime.start.p0(i64 -1, ptr %"$_")
  ...
  %6 = getelementptr %"unsigned int64_int64__tuple_t", ptr %"$_", i32 0, i32 1
  store i64 %val, ptr %6, align 8
  %"ctx.$var1" = getelementptr %ctx_t.3, ptr %3, i64 0, i32 0
  %"$var1" = load ptr, ptr %"ctx.$var1", align 8
  %"ctx.$var2" = getelementptr %ctx_t.3, ptr %3, i64 0, i32 1
...
!48 = distinct !DIGlobalVariable(name: "stack", linkageName: "global", scope: !2, file: !2, type: !49, isLocal: false, isDefinition: true)
...
!58 = !DICompositeType(tag: DW_TAG_array_type, baseType: !59, size: 32768, elements: !14)
...
!69 = distinct !DISubprogram(name: "map_for_each_cb", linkageName: "map_for_each_cb", scope: !2, file: !2, type: !64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !60, retainedNodes: !70)
!70 = !{!71}
!71 = !DILocalVariable(name: "ctx", arg: 1, scope: !69, file: !2, type: !66)
!72 = distinct !DISubprogram(name: "map_for_each_cb_1", linkageName: "map_for_each_cb_1", scope: !2, file: !2, type: !64, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !60, retainedNodes: !73)
!73 = !{!74}
!74 = !DILocalVariable(name: "ctx", arg: 1, scope: !72, file: !2, type: !66)
