...
@map_key_buf = dso_local externally_initialized global [1 x [2 x [8 x i8]]] zeroinitializer, section ".data.map_key_buf", !dbg !44
...
@read_map_val_buf = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.read_map_val_buf", !dbg !59
...
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !47, size: 128, elements: !9)
!47 = !DICompositeType(tag: DW_TAG_array_type, baseType: !48, size: 128, elements: !51)
!48 = !DICompositeType(tag: DW_TAG_array_type, baseType: !27, size: 64, elements: !49)
!49 = !{!50}
...
!56 = !DICompositeType(tag: DW_TAG_array_type, baseType: !48, size: 64, elements: !9)
...
!60 = distinct !DIGlobalVariable(name: "read_map_val_buf", linkageName: "global", scope: !2, file: !2, type: !55, isLocal: false, isDefinition: true)
