...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.1" zeroinitializer, section ".maps", !dbg !35
@stack_scratch = dso_local global %"struct map_internal_repr_t.2" zeroinitializer, section ".maps", !dbg !55
@ringbuf = dso_local global %"struct map_internal_repr_t.3" zeroinitializer, section ".maps", !dbg !67
