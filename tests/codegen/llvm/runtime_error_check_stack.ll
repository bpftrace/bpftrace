...
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !81
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !83

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

; Function Attrs: nounwind
define i64 @kprobe_f_1(ptr %0) #0 section "s_kprobe_f_1" !dbg !94 {
entry:
...
event_loss_counter:                               ; preds = %helper_failure
  ...
  %19 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
event_loss_counter5:                              ; preds = %helper_failure1
  ...
  %26 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded9, i64 0, i64 0
...
event_loss_counter15:                             ; preds = %helper_failure11
  %get_cpu_id18 = call i64 inttoptr (i64 8 to ptr)()
  %32 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded19 = and i64 %get_cpu_id18, %32
  %33 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded19, i64 0, i64 0
...
event_loss_counter36:                             ; preds = %helper_failure32
  %get_cpu_id39 = call i64 inttoptr (i64 8 to ptr)()
  %50 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded40 = and i64 %get_cpu_id39, %50
  %51 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded40, i64 0, i64 0
...
event_loss_counter47:                             ; preds = %helper_failure43
  %get_cpu_id50 = call i64 inttoptr (i64 8 to ptr)()
  %57 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded51 = and i64 %get_cpu_id50, %57
  %58 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded51, i64 0, i64 0
...
event_loss_counter57:                             ; preds = %helper_failure53
  %get_cpu_id60 = call i64 inttoptr (i64 8 to ptr)()
  %64 = load i64, ptr @__bt__max_cpu_id, align 8
  %cpu.id.bounded61 = and i64 %get_cpu_id60, %64
  %65 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded61, i64 0, i64 0
...
!82 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
!83 = !DIGlobalVariableExpression(var: !84, expr: !DIExpression())
!84 = distinct !DIGlobalVariable(name: "__bt__event_loss_counter", linkageName: "global", scope: !2, file: !2, type: !85, isLocal: false, isDefinition: true)
!85 = !DICompositeType(tag: DW_TAG_array_type, baseType: !86, size: 64, elements: !15)
!86 = !DICompositeType(tag: DW_TAG_array_type, baseType: !87, size: 64, elements: !15)
!87 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 64, elements: !88)
!88 = !{!89}
!89 = !DISubrange(count: 8, lowerBound: 0)
...
!91 = !{!0, !7, !26, !35, !55, !67, !81, !83}
!92 = !{i32 2, !"Debug Info Version", i32 3}
!93 = !{i32 7, !"uwtable", i32 0}
!94 = distinct !DISubprogram(name: "kprobe_f_1", linkageName: "kprobe_f_1", scope: !2, file: !2, type: !95, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !90, retainedNodes: !98)
