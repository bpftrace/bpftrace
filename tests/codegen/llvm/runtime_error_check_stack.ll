...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !81
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !88
...
!84 = !DICompositeType(tag: DW_TAG_array_type, baseType: !85, size: 64, elements: !15)
!85 = !DICompositeType(tag: DW_TAG_array_type, baseType: !4, size: 64, elements: !86)
!86 = !{!87}
!87 = !DISubrange(count: 8, lowerBound: 0)
!88 = !DIGlobalVariableExpression(var: !89, expr: !DIExpression())
!89 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
