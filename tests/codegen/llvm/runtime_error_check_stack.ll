...
@stack_bpftrace_127 = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !35
@stack_scratch = dso_local global %"struct map_internal_repr_t.151" zeroinitializer, section ".maps", !dbg !55
@ringbuf = dso_local global %"struct map_internal_repr_t.152" zeroinitializer, section ".maps", !dbg !67
