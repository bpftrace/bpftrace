...
define i64 @self_signal_SIGUSR1_1(ptr %0) section "s_self_signal_SIGUSR1_1" !dbg !51 {
entry:
  %"@x_key" = alloca i64, align 8
  %probe = alloca [20 x i8], align 1
  call void @llvm.lifetime.start.p0(i64 -1, ptr %probe)
  call void @llvm.memset.p0.i64(ptr align 1 %probe, i8 0, i64 20, i1 false)
  store [20 x i8] c"self:signal:SIGUSR1\00", ptr %probe, align 1
...
!51 = distinct !DISubprogram(name: "self_signal_SIGUSR1_1", linkageName: "self_signal_SIGUSR1_1", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !48, retainedNodes: !55)
