...
; Function Attrs: nounwind
define i64 @kprobe_f_2(ptr %0) #0 section "s_kprobe_f_2" !dbg !48 {
entry:
...
event_loss_counter:                               ; preds = %entry
  %5 = atomicrmw add ptr @__bt__event_loss_counter, i64 1 seq_cst, align 8
...
!48 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !43, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !38, retainedNodes: !49)
!49 = !{!50}
!50 = !DILocalVariable(name: "ctx", arg: 1, scope: !48, file: !2, type: !45)
