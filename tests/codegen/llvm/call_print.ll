...
; Function Attrs: nounwind
define i64 @kprobe_f_2(ptr %0) #0 section "s_kprobe_f_2" !dbg !55 {
entry:
  ...
  %4 = getelementptr %print_t, ptr %"print_@x", i64 0, i32 3
  store i32 0, ptr %4, align 4
  %ringbuf_output = call i64 inttoptr (i64 130 to ptr)(ptr @ringbuf, ptr %"print_@x", i64 20, i64 0)
...
event_loss_counter:                               ; preds = %entry
  ...
  %6 = getelementptr [1 x [1 x [8 x i8]]], ptr @__bt__event_loss_counter, i64 0, i64 %cpu.id.bounded, i64 0, i64 0
...
counter_merge:                                    ; preds = %event_loss_counter, %entry
  call void @llvm.lifetime.end.p0(i64 -1, ptr %"print_@x")
  ret i64 0
}
...
!48 = !{i32 7, !"uwtable", i32 0}
!49 = distinct !DISubprogram(name: "BEGIN_1", linkageName: "BEGIN_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
...
!55 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !56)
!56 = !{!57}
!57 = !DILocalVariable(name: "ctx", arg: 1, scope: !55, file: !2, type: !52)
