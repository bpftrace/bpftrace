...
define i64 @kprobe_f_2(ptr %0) section "s_kprobe_f_2" !dbg !52 {
entry:
...
!52 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !46, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !42, retainedNodes: !53)
!53 = !{!54}
!54 = !DILocalVariable(name: "ctx", arg: 1, scope: !52, file: !2, type: !48)
