...
; Function Attrs: nounwind
define i64 @interval_s_1_1(ptr %0) #0 section "s_interval_s_1_1" !dbg !49 {
entry:
...
while_cond1:                                      ; preds = %lookup_merge, %while_body
  ...
  br i1 %true_cond4, label %while_body2, label %while_end3, !llvm.loop !55
...
!49 = distinct !DISubprogram(name: "interval_s_1_1", linkageName: "interval_s_1_1", scope: !2, file: !2, type: !50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !45, retainedNodes: !53)
