...
%errorf_args_t = type { [13 x i8], i32 }
...
@"signal_thread()" = global [13 x i8] c"signal_thread()\00"
...
left:                                             ; preds = %entry
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %6, ptr align 1 @"signal_thread()", i64 13, i1 false)
...
!41 = !DILocation(line: 28, column: 30, scope: !35)
