...
@num_cpus = dso_local externally_initialized constant i64 1, section ".rodata", !dbg !64

; Function Attrs: nounwind
declare i64 @llvm.bpf.pseudo(i64 %0, i64 %1) #0

define i64 @kretprobe_f_1(ptr %0) section "s_kretprobe_f_1" !dbg !69 {
entry:
...
lookup_failure:                                   ; preds = %entry
  ...
  store i64 %4, ptr %initial_value, align 8
...
!65 = distinct !DIGlobalVariable(name: "num_cpus", linkageName: "global", scope: !2, file: !2, type: !18, isLocal: false, isDefinition: true)
...
!69 = distinct !DISubprogram(name: "kretprobe_f_1", linkageName: "kretprobe_f_1", scope: !2, file: !2, type: !70, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !66, retainedNodes: !73)
