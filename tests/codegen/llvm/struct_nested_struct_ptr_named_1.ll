...
entry:
  ...
  %probe_read_kernel = call i64 inttoptr (i64 113 to ptr)(ptr %"struct Foo.bar", i32 8, ptr %5)
  %6 = load ptr, ptr %"struct Foo.bar", align 8
  ...
  %probe_read_kernel1 = call i64 inttoptr (i64 113 to ptr)(ptr %"struct Bar.x", i32 4, ptr %8)
