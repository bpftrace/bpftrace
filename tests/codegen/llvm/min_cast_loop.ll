...
while_end:                                        ; preds = %error_failure, %error_success, %while_cond
  ...
  %18 = getelementptr %"unsigned int64_min__tuple_t", %"unsigned int64_min__tuple_t"* %"$kv", i32 0, i32 1
  store i64 %13, i64* %18, align 8
  %19 = getelementptr %"unsigned int64_min__tuple_t", %"unsigned int64_min__tuple_t"* %"$kv", i32 0, i32 0
  %20 = load i64, i64* %19, align 8
  %21 = getelementptr %"unsigned int64_min__tuple_t", %"unsigned int64_min__tuple_t"* %"$kv", i32 0, i32 1
  ...
  %25 = getelementptr %"unsigned int64_min__tuple_t", %"unsigned int64_min__tuple_t"* %tuple, i32 0, i32 0
  store i64 %20, i64* %25, align 8
  %26 = getelementptr %"unsigned int64_min__tuple_t", %"unsigned int64_min__tuple_t"* %tuple, i32 0, i32 1
  ...
  %33 = bitcast %"unsigned int64_min__tuple_t"* %tuple to i8*
...
counter_merge:                                    ; preds = %lookup_merge, %while_end
  ...
  %46 = bitcast %"unsigned int64_min__tuple_t"* %tuple to i8*
