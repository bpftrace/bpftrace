...
define internal i64 @map_for_each_cb(ptr %0, ptr %1, ptr %2, ptr %3) section ".text" !dbg !90 {
...
!77 = !{!78}
!78 = !DISubrange(count: 32, lowerBound: 0)
...
!90 = distinct !DISubprogram(name: "map_for_each_cb", linkageName: "map_for_each_cb", scope: !2, file: !2, type: !85, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !81, retainedNodes: !91)
!91 = !{!92}
!92 = !DILocalVariable(name: "ctx", arg: 1, scope: !90, file: !2, type: !87)
