...
@__bt__var_buf = dso_local externally_initialized global [1 x [1 x [1024 x i8]]] zeroinitializer, section ".data.var_buf", !dbg !31
@__bt__get_str_buf = dso_local externally_initialized global [1 x [1 x [1024 x i8]]] zeroinitializer, section ".data.get_str_buf", !dbg !38
...
entry:
  ...
  %2 = getelementptr [1 x [1 x [1024 x i8]]], ptr @__bt__var_buf, i64 0, i64 %cpu.id.bounded2, i64 0, i64 0
...
if_end:                                           ; preds = %merge, %if_body
  %7 = load i8, ptr %"$$strcontains_$found", align 1
  ret i64 0

"||_lhs_false":                                   ; preds = %entry
  %8 = ptrtoint ptr %"$$strcontains_$needle" to i64
  ...
  %probe_read_kernel5 = call i64 inttoptr (i64 113 to ptr)(ptr %array_access, i32 1, ptr %11)
  %12 = load i8, ptr %array_access, align 1
  call void @llvm.lifetime.end.p0(i64 -1, ptr %array_access)
  %13 = sext i8 %12 to i64
  %14 = icmp eq i64 %13, 0
  %rhs_true_cond = icmp ne i1 %14, false
...
"||_merge":                                       ; preds = %"||_true", %"||_false"
  %15 = load i8, ptr %"||_result", align 1
  %true_cond = icmp ne i8 %15, 0
