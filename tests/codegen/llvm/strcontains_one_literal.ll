...
"||_lhs_false":                                   ; preds = %entry
  ...
  %probe_read_kernel5 = call i64 inttoptr (i64 113 to ptr)(ptr %array_access, i32 1, ptr %15)
  %16 = load i8, ptr %array_access, align 1
