...
strcontains.inner.cmp:                            ; preds = %strcontains.inner.notnull
  ...
  %21 = icmp ne i8 %20, %15
  %22 = or i1 %18, %21
  br i1 %22, label %strcontains.outer.incr, label %strcontains.inner.incr

strcontains.inner.incr:                           ; preds = %strcontains.inner.cmp
  %23 = load i64, ptr %strcontains.j, align 8
  %24 = add i64 %23, 1
  store i64 %24, ptr %strcontains.j, align 8
  br label %strcontains.inner.cond

strcontains.outer.incr:                           ; preds = %strcontains.inner.cmp, %strcontains.inner.notnull, %strcontains.inner.cond
  %25 = load i64, ptr %strcontains.i, align 8
  %26 = add i64 %25, 1
  store i64 %26, ptr %strcontains.i, align 8
