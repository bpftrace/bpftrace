...
entry:
  ...
  %7 = load i64, ptr %"$$strstr_0_$needle_size", align 8
  %8 = icmp eq i64 %7, 0
...
right:                                            ; preds = %entry
  %9 = load i64, ptr %"$$strstr_0_$haystack_size", align 8
  %__bpf_strnstr = call i64 @__bpf_strnstr(ptr %2, ptr %"$$strstr_0_$needle", i64 %9, ptr %"$$strstr_0_$index"), !dbg !54
  %10 = icmp sge i64 %__bpf_strnstr, 0
  %true_cond8 = icmp ne i1 %10, false
  br i1 %true_cond8, label %left5, label %right6

done:                                             ; preds = %done7, %left
  %11 = load i64, ptr %"$$strstr_0_$index", align 8
...
is_positive:                                      ; preds = %right6
  %bpf_loop = call i64 inttoptr (i64 181 to ptr)(i32 %21, ptr @loop_cb, ptr %ctx, i64 0)
  br label %merge
