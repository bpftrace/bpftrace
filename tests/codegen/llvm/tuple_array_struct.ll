...
; Function Attrs: nounwind
define i64 @p1_0(ptr %0) #0 section "probes" !dbg !62 {
entry:
...
!62 = distinct !DISubprogram(name: "p1_0", linkageName: "p1_0", scope: !2, file: !2, type: !63, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !58, retainedNodes: !66)
