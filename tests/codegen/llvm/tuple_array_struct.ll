...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !46
...
!29 = !DIDerivedType(tag: DW_TAG_member, scope: !2, file: !2, baseType: !30, size: 128, offset: 64)
!30 = !DICompositeType(tag: DW_TAG_array_type, baseType: !31, size: 128, elements: !5)
...
!49 = !DICompositeType(tag: DW_TAG_array_type, baseType: !26, size: 64, elements: !15)
