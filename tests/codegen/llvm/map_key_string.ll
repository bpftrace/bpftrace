...
entry:
  ...
  %4 = zext [2 x i8]* %str to i64
  %5 = bitcast i8* %3 to [2 x i8]**
  store i64 %4, [2 x i8]** %5, align 8
  %6 = bitcast [2 x i8]* %str to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %6)
  %7 = bitcast [2 x i8]* %str1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 -1, i8* %7)
  store [2 x i8] c"b\00", [2 x i8]* %str1, align 1
  %8 = getelementptr [4 x i8], [4 x i8]* %"@x_key", i64 0, i64 2
  %9 = zext [2 x i8]* %str1 to i64
  %10 = bitcast i8* %8 to [2 x i8]**
  store i64 %9, [2 x i8]** %10, align 8
