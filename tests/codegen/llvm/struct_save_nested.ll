...
@AT_bar = dso_local global %"struct map_t" zeroinitializer, section ".maps", !dbg !7
@AT_foo = dso_local global %"struct map_t.0" zeroinitializer, section ".maps", !dbg !26
@AT_x = dso_local global %"struct map_t.1" zeroinitializer, section ".maps", !dbg !35
@ringbuf = dso_local global %"struct map_t.2" zeroinitializer, section ".maps", !dbg !40
@__bt__max_cpu_id = dso_local externally_initialized constant i64 0, section ".rodata", !dbg !54
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !56
...
!55 = distinct !DIGlobalVariable(name: "__bt__max_cpu_id", linkageName: "global", scope: !2, file: !2, type: !20, isLocal: false, isDefinition: true)
...
!59 = !DICompositeType(tag: DW_TAG_array_type, baseType: !23, size: 64, elements: !15)
