...
@__bt__event_loss_counter = dso_local externally_initialized global [1 x [1 x [8 x i8]]] zeroinitializer, section ".data.event_loss_counter", !dbg !54
...
!57 = !DICompositeType(tag: DW_TAG_array_type, baseType: !23, size: 64, elements: !15)
