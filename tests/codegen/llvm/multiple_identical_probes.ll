...
; Function Attrs: nounwind
define i64 @kprobe_f_2(ptr %0) #0 section "s_kprobe_f_2" !dbg !35 {
entry:
  ret i64 0
}
...
!35 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !25, retainedNodes: !36)
!36 = !{!37}
!37 = !DILocalVariable(name: "ctx", arg: 1, scope: !35, file: !2, type: !32)
