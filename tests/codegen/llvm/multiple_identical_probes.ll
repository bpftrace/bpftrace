...
define i64 @kprobe_f_2(ptr %0) section "s_kprobe_f_2" !dbg !27 {
entry:
  ret i64 0
}
...
!27 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !20, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !16, retainedNodes: !28)
!28 = !{!29}
!29 = !DILocalVariable(name: "ctx", arg: 1, scope: !27, file: !2, type: !23)
