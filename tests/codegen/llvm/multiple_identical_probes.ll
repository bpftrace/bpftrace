...
; Function Attrs: nounwind
define i64 @kprobe_f_2(ptr %0) #0 section "s_kprobe_f_2" !dbg !44 {
entry:
  ret i64 0
}
...
!44 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !39, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !34, retainedNodes: !45)
!45 = !{!46}
!46 = !DILocalVariable(name: "ctx", arg: 1, scope: !44, file: !2, type: !41)
