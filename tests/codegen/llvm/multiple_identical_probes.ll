...
define i64 @kprobe_f_2(ptr %0) section "s_kprobe_f_2" !dbg !60 {
entry:
  ret i64 0
}
...
!60 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !55, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !61)
!61 = !{!62}
