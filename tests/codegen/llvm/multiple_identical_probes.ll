...
; Function Attrs: nounwind
define i64 @kprobe_f_2(ptr %0) #0 section "s_kprobe_f_2" !dbg !41 {
entry:
  ret i64 0
}
...
!41 = distinct !DISubprogram(name: "kprobe_f_2", linkageName: "kprobe_f_2", scope: !2, file: !2, type: !36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !31, retainedNodes: !42)
!42 = !{!43}
!43 = !DILocalVariable(name: "ctx", arg: 1, scope: !41, file: !2, type: !38)
