...
define i64 @"uprobe:/bin/sh:f"(i8* %0) section "s_uprobe:/bin/sh:f_1" !dbg !29 {
entry:
...
!29 = distinct !DISubprogram(name: "uprobe__bin_sh_f", linkageName: "uprobe__bin_sh_f", scope: !2, file: !2, type: !30, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !25, retainedNodes: !33)
