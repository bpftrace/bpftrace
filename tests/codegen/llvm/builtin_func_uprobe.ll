...
define i64 @"uprobe:/bin/sh:f"(i8* %0) section "s_uprobe:/bin/sh:f_1" !dbg !3 {
entry:
...
!2 = !{}
!3 = distinct !DISubprogram(name: "uprobe__bin_sh_f", linkageName: "uprobe__bin_sh_f", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
