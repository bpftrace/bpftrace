...
entry:
  ...
  %2 = getelementptr [1 x [2 x [1024 x i8]]], ptr @__bt__var_buf, i64 0, i64 %cpu.id.bounded10, i64 1, i64 0
  ...
  %4 = getelementptr [1 x [2 x [1024 x i8]]], ptr @__bt__var_buf, i64 0, i64 %cpu.id.bounded2, i64 0, i64 0
...
if_end:                                           ; preds = %merge, %if_body
  %13 = load i8, ptr %"$$strcontains_$found", align 1
  ret i64 0
...
"||_lhs_false":                                   ; preds = %entry
  ...
  %probe_read_kernel13 = call i64 inttoptr (i64 113 to ptr)(ptr %array_access, i32 1, ptr %17)
...
"||_merge":                                       ; preds = %"||_true", %"||_false"
  %21 = load i8, ptr %"||_result", align 1
  %true_cond = icmp ne i8 %21, 0
