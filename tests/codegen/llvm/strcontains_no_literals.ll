...
entry:
  ...
  store i64 1024, ptr %"$$strstr_0_$haystack_size", align 8
  store i64 1024, ptr %"$$strstr_0_$needle_size", align 8
  %13 = load i64, ptr %"$$strstr_0_$needle_size", align 8
  %14 = icmp eq i64 %13, 0
...
right:                                            ; preds = %entry
  %15 = load i64, ptr %"$$strstr_0_$haystack_size", align 8
  %__bpf_strnstr = call i64 @__bpf_strnstr(ptr %4, ptr %2, i64 %15, ptr %"$$strstr_0_$index"), !dbg !54
  %16 = icmp sge i64 %__bpf_strnstr, 0
  %true_cond16 = icmp ne i1 %16, false
  br i1 %true_cond16, label %left13, label %right14

done:                                             ; preds = %done15, %left
  %17 = load i64, ptr %"$$strstr_0_$index", align 8
...
right14:                                          ; preds = %right
  store i1 false, ptr %"$$strstr_0_$found", align 1
  %19 = load i64, ptr %"$$strstr_0_$haystack_size", align 8
  %20 = sub i64 %19, 0
  call void @llvm.lifetime.start.p0(i64 -1, ptr %ctx)
  %21 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %"ctx.$$strstr_0_$haystack" = getelementptr %ctx_t, ptr %21, i64 0, i32 0
  store ptr %4, ptr %"ctx.$$strstr_0_$haystack", align 8
  %22 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %"ctx.$$strstr_0_$needle_size" = getelementptr %ctx_t, ptr %22, i64 0, i32 1
  store ptr %"$$strstr_0_$needle_size", ptr %"ctx.$$strstr_0_$needle_size", align 8
  %23 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %"ctx.$$strstr_0_$needle" = getelementptr %ctx_t, ptr %23, i64 0, i32 2
  store ptr %2, ptr %"ctx.$$strstr_0_$needle", align 8
  %24 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %"ctx.$$strstr_0_$index" = getelementptr %ctx_t, ptr %24, i64 0, i32 3
  store ptr %"$$strstr_0_$index", ptr %"ctx.$$strstr_0_$index", align 8
  %25 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %"ctx.$$strstr_0_$found" = getelementptr %ctx_t, ptr %25, i64 0, i32 4
  store ptr %"$$strstr_0_$found", ptr %"ctx.$$strstr_0_$found", align 8
  %26 = call ptr @llvm.preserve.static.offset(ptr %ctx)
  %ctx.start = getelementptr %ctx_t, ptr %26, i64 0, i32 5
  store i64 0, ptr %ctx.start, align 8
  %27 = trunc i64 %20 to i32
  %is_positive_cond = icmp sgt i32 %27, 0
  br i1 %is_positive_cond, label %is_positive, label %merge

done15:                                           ; preds = %merge, %left13
  br label %done

is_positive:                                      ; preds = %right14
  %bpf_loop = call i64 inttoptr (i64 181 to ptr)(i32 %27, ptr @loop_cb, ptr %ctx, i64 0)
  br label %merge

merge:                                            ; preds = %is_positive, %right14
  br label %done15
}
...
!54 = !DILocation(line: 101, column: 13, scope: !48)
