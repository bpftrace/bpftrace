...
define i64 @kprobe_foo_1(ptr %0) section "s_kprobe_foo_1" !dbg !34 {
entry:
...
!34 = distinct !DISubprogram(name: "kprobe_foo_1", linkageName: "kprobe_foo_1", scope: !2, file: !2, type: !35, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !31, retainedNodes: !38)
