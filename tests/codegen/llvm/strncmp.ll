...
define i64 @"tracepoint:file:filename"(i8* %0) section "s_tracepoint:file:filename_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "tracepoint_file_filename", linkageName: "tracepoint_file_filename", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
