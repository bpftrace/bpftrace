...
define i64 @"tracepoint:file:filename"(i8* %0) section "s_tracepoint:file:filename_1" !dbg !3 {
entry:
...
!2 = !{}
!3 = distinct !DISubprogram(name: "tracepoint_file_filename", linkageName: "tracepoint_file_filename", scope: !1, file: !1, type: !4, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !9)
