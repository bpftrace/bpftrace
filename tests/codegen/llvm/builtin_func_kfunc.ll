...
define i64 @kfunc_mock_vmlinux_f_1(i8* %0) section "s_kfunc_mock_vmlinux_f_1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_f_1", linkageName: "kfunc_mock_vmlinux_f_1", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
