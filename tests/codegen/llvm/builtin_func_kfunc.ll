...
define i64 @"kfunc:mock_vmlinux:f"(i8* %0) section "s_kfunc:mock_vmlinux:f_1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_f", linkageName: "kfunc_mock_vmlinux_f", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
