...
define i64 @"kfunc:mock_vmlinux:f"(i8* %0) section "s_kfunc:mock_vmlinux:f_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "kfunc_mock_vmlinux_f", linkageName: "kfunc_mock_vmlinux_f", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
