...
lookup_fmtstr_merge:                              ; preds = %entry
  call void @llvm.memset.p0i8.i64(i8* align 1 %lookup_fmtstr_map, i8 0, i64 24, i1 false)
  %6 = bitcast i8* %lookup_fmtstr_map to %printf_t*
  %7 = getelementptr %printf_t, %printf_t* %6, i32 0, i32 0
  ...
  %10 = load i8, i8* %"struct Foo.c", align 1
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %"struct Foo.c")
  %11 = bitcast i8* %lookup_fmtstr_map to %printf_t*
  %12 = getelementptr %printf_t, %printf_t* %11, i32 0, i32 1
  ...
  %probe_read_kernel1 = call i64 inttoptr (i64 113 to i64 (i64*, i32, i64)*)(i64* %"struct Foo.l", i32 8, i64 %15)
  %17 = load i64, i64* %"struct Foo.l", align 8
  %18 = bitcast i64* %"struct Foo.l" to i8*
  call void @llvm.lifetime.end.p0i8(i64 -1, i8* %18)
  %19 = bitcast i8* %lookup_fmtstr_map to %printf_t*
  %20 = getelementptr %printf_t, %printf_t* %19, i32 0, i32 2
  store i64 %17, i64* %20, align 8
  %ringbuf_output = call i64 inttoptr (i64 130 to i64 (%"struct map_t"*, i8*, i64, i64)*)(%"struct map_t"* @ringbuf, i8* %lookup_fmtstr_map, i64 24, i64 0)
