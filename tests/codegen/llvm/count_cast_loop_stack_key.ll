...
@stack_raw_127 = dso_local global %"struct map_internal_repr_t.149" zeroinitializer, section ".maps", !dbg !30
@stack_scratch = dso_local global %"struct map_internal_repr_t.150" zeroinitializer, section ".maps", !dbg !49
@ringbuf = dso_local global %"struct map_internal_repr_t.151" zeroinitializer, section ".maps", !dbg !66
