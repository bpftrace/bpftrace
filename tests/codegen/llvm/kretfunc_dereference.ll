...
define i64 @"kretfunc:mock_vmlinux:sk_alloc"(i8* %0) section "s_kretfunc:mock_vmlinux:sk_alloc_1" !dbg !55 {
entry:
...
!55 = distinct !DISubprogram(name: "kretfunc_mock_vmlinux_sk_alloc", linkageName: "kretfunc_mock_vmlinux_sk_alloc", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
