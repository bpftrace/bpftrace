...
define i64 @kretfunc_mock_vmlinux_sk_alloc_1(i8* %0) section "s_kretfunc_mock_vmlinux_sk_alloc_1" !dbg !55 {
entry:
...
lookup_success:                                   ; preds = %entry
  ...
  %9 = atomicrmw add i64* %cast1, i64 1 seq_cst
...
!55 = distinct !DISubprogram(name: "kretfunc_mock_vmlinux_sk_alloc_1", linkageName: "kretfunc_mock_vmlinux_sk_alloc_1", scope: !2, file: !2, type: !56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !51, retainedNodes: !60)
