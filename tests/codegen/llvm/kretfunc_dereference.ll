...
define i64 @"kretfunc:mock_vmlinux:sk_alloc"(i8* %0) section "s_kretfunc:mock_vmlinux:sk_alloc_1" !dbg !24 {
entry:
...
!24 = distinct !DISubprogram(name: "kretfunc_mock_vmlinux_sk_alloc", linkageName: "kretfunc_mock_vmlinux_sk_alloc", scope: !2, file: !2, type: !25, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !20, retainedNodes: !29)
