...
define i64 @kretfunc_mock_vmlinux_sk_alloc_1(i8* %0) section "s_kretfunc_mock_vmlinux_sk_alloc_1" !dbg !51 {
entry:
...
!51 = distinct !DISubprogram(name: "kretfunc_mock_vmlinux_sk_alloc_1", linkageName: "kretfunc_mock_vmlinux_sk_alloc_1", scope: !2, file: !2, type: !52, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !47, retainedNodes: !56)
