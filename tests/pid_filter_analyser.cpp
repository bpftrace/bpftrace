...
#include "ast/passes/pid_filter_analyser.h"
#include "ast/passes/printer.h"
#include "clang_parser.h"
#include "driver.h"
#include "mocks.h"

namespace bpftrace::test::pid_filter_analyser {
...
void test(std::string_view input, bool has_pid, bool has_filter)
{
  ...
  ASSERT_EQ(driver.parse_str(input), 0);
  ast::PidFilterAnalyser pid_filter(driver.ctx, bpftrace);
  pid_filter.analyse();
...
TEST(pid_filter_analyser, add_filter)
{
