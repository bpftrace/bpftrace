...
TEST(semantic_analyser, block_scoping)
{
  ...
  test("BEGIN { $a = 1; if (1) { print(($a)); $b = 2; if (1) { print(($a, "
       "$b)); } else { print(($a, $b)); } } }");

  // for loops
  test("BEGIN { @x[0] = 1; $a = 1; for ($kv : @x) "
       "{ $b = 2; print(($a, $b)); } }");
  test("BEGIN { @x[0] = 1; @y[0] = 2; $a = 1; for ($kv : @x) "
       "{ $b = 2; for ($ap : @y) { print(($a, $b)); } } }");

  // while loops
  test("BEGIN { $a = 1; while (1) { $b = 2; print(($a, $b)); } }");
  test("BEGIN { $a = 1; while (1) { print(($a)); $b = 2; while (1) { "
       "print(($a, $b)); } } }");
  ...
  // mixed
  test("BEGIN { $a = 1; @x[0] = 1; if (1) { $b = 2; for ($kv : @x) { $c = 3; "
       "while (1) { $d = 4; unroll(1) { $e = 5; print(($a, $b, $c, $d, $e)); } "
       "} } } }");
