...
TEST_F(SemanticAnalyserBTFTest, fentry)
{
  ...
  if (arch::Host::Machine == arch::Machine::X86_64) {
    test("fentry:func_1 { reg(\"ip\") }",
         Error{ R"(ERROR: reg can not be used with "fentry" probes)" });
    test("fexit:func_1 { reg(\"ip\") }",
         Error{ R"(ERROR: reg can not be used with "fexit" probes)" });
  }
...
TEST_F(SemanticAnalyserBTFTest, kfunc)
{
  ...
  if (arch::Host::Machine == arch::Machine::X86_64) {
    test("kfunc:func_1 { reg(\"ip\") }",
         Error{ R"(ERROR: reg can not be used with "fentry" probes)" });
    test("kretfunc:func_1 { reg(\"ip\") }",
         Error{ R"(ERROR: reg can not be used with "fexit" probes)" });
  }
  // Backwards compatibility
