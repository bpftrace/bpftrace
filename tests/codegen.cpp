...
entry:
  ...
  %str.repack = getelementptr inbounds [64 x i8], [64 x i8]* %str, i64 0, i64 0
  store i8 98, i8* %str.repack, align 1
...
entry:
  ...
  %str.sroa.0.0..sroa_idx = getelementptr inbounds [128 x i8], [128 x i8]* %"@x_key", i64 0, i64 0
  store i8 97, i8* %str.sroa.0.0..sroa_idx, align 1
  %str.sroa.2.0..sroa_idx = getelementptr inbounds [128 x i8], [128 x i8]* %"@x_key", i64 0, i64 1
  %str1.sroa.0.0..sroa_idx = getelementptr inbounds [128 x i8], [128 x i8]* %"@x_key", i64 0, i64 64
  call void @llvm.memset.p0i8.i64(i8* %str.sroa.2.0..sroa_idx, i8 0, i64 63, i32 1, i1 false)
  store i8 98, i8* %str1.sroa.0.0..sroa_idx, align 1
  %str1.sroa.2.0..sroa_idx = getelementptr inbounds [128 x i8], [128 x i8]* %"@x_key", i64 0, i64 65
  call void @llvm.memset.p0i8.i64(i8* %str1.sroa.2.0..sroa_idx, i8 0, i64 63, i32 1, i1 false)
  store i64 44, i64* %"@x_val", align 8
  %pseudo = tail call i64 @llvm.bpf.pseudo(i64 1, i64 3)
...
lookup_success:                                   ; preds = %entry
  %24 = load i64, i8* %lookup_elem, align 8
  %phitmp = add i64 %24, 1
...
lookup_success:                                   ; preds = %entry
  %1 = load i64, i8* %lookup_elem, align 8
  %phitmp = add i64 %1, 1
  br label %lookup_merge
...
entry:
  ...
  %probe_read = call i64 inttoptr (i64 4 to i64 (i8*, i64, i8*)*)(i64* nonnull %arg0, i64 8, i8* %1)
  %2 = load i64, i64* %arg0, align 8
  %probe_read_str = call i64 inttoptr (i64 45 to i64 (i8*, i64, i8*)*)([64 x i8]* nonnull %str, i64 64, i64 %2)
  store i64 0, i64* %"@x_key", align 8
...
lookup_merge:                                     ; preds = %entry, %lookup_success
  %lookup_elem_val.0 = phi i64 [ %1, %lookup_success ], [ 0, %entry ]
...
entry:
  ...
  %str = alloca [64 x i8], align 1
  %str.repack = getelementptr inbounds [64 x i8], [64 x i8]* %str, i64 0, i64 0
  store i8 97, i8* %str.repack, align 1
