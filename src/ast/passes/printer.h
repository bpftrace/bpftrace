...
// BuffeBuffer is an internal type foBuffer output construction.
class Buffer {
public:
  Buffer();
  ~Buffer();
...
// BuffeBuffer is directly printable, used below.
...
// Generic class foBuffer printing AST nodes.
...
private:
  ...
  Buffer format_list(std::vector<Expression> &exprs,
