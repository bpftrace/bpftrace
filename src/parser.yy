...
%type <ast::Map *> map map_decl_stmt
%type <ast::MapInitializer *> map_initializer
...
map_decl_stmt:
                LET MAP ASSIGN map_initializer { $$ = driver.ctx.make_node<ast::Map>($2, $4, @$); }
        ;

map_initializer:
                IDENT LPAREN RPAREN { $$ = driver.ctx.make_node<ast::MapInitializer>($1, @$); }
        |       IDENT LPAREN INT RPAREN { $$ = driver.ctx.make_node<ast::MapInitializer>($1, $3, @$); }
        ;
