...
public:
   ...
   // Simple passthrough.
  void map([[maybe_unused]] const std::string &name, [[maybe_unused]] const Value &value) override {}
  ...
  void benchmark_result([[maybe_unused]] const std::vector<std::string> &all_benches,
                        [[maybe_unused]] size_t index,
                        [[maybe_unused]] std::chrono::nanoseconds average, [[maybe_unused]] size_t iters) override { }
  void end() override { }

  // Increment our counters.
  void lost_events([[maybe_unused]] uint64_t lost) override { }
  void attached_probes([[maybe_unused]] uint64_t num_probes) override { }
  void runtime_error([[maybe_unused]] int retcode, [[maybe_unused]] const RuntimeErrorInfo &info) override { }
};
