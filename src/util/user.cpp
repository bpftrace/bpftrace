...
Result<> UserFunctionInfoImpl::read_probes_for_pid(int pid)
{
...
Result<> UserFunctionInfoImpl::read_probes_for_path(const std::string& path)
{
...
Result<std::unique_ptr<std::istream>> UserFunctionInfoImpl::
    get_symbols_from_file(const std::string& path)
{
...
Result<std::unique_ptr<std::istream>> UserFunctionInfoImpl::
    get_func_symbols_from_file(std::optional<int> pid, const std::string& path)
{
  if (path.empty())
...
Result<std::unique_ptr<std::istream>> UserFunctionInfoImpl::
    get_symbols_from_usdt(std::optional<int> pid, const std::string& target)
{
...
Result<usdt_probe_list> UserFunctionInfoImpl::usdt_probes_for_pid(int pid)
{
  auto ok = read_probes_for_pid(pid);
  if (!ok) {
    return ok.takeError();
...
Result<usdt_probe_list> UserFunctionInfoImpl::usdt_probes_for_all_pids()
{
  usdt_probe_list probes;
