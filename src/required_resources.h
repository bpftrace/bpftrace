...
public:
  // This classe effectively wraps a location, but preserves only the parts
  // that are needed to emit the error in a useful way. This is because it may
  // be serialized and used by a separate runtime.
