...
static std::optional<std::string> get_field_decl_annotation(CXCursor c)
{
...
Pass CreateClangPass(std::vector<std::string> &&extra_flags) {
  return Pass::create("ClangParser", [extra_flags = std::move(extra_flags)](ASTContext &ast, BPFtrace& b) {
    ClangParser parser;
